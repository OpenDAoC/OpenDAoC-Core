...
namespace DOLDatabase.Tables
{
    ...
    public class DbSkinVendorItems : DataObject
    {
        ...
        public DbSkinVendorItems(string name, int modelId, int itemType, int playerRealmRank, int accountRealmRank, int drake, int orbs,int epicBossKills,int masteredCrafts, int realm, int characterClass, int objectType, int damagetype, int price)
        {
            Name = name;
            ModelID = modelId;
            ItemType = itemType;
