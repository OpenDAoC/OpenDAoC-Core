...
namespace DOL.Database
{
	...
	public class DbItemTemplates : DataObject
		
	{
		...
		public DbItemTemplates(DbItemTemplates template)
		{
			AllowUpdate = false;
		...
		/// <returns></returns>
		public int GetBonusAmount(DbArtifactBonuses.ID bonusID)
		{
			switch ((int)bonusID)
			{
				case 0:
		...
		/// <param name="bonusID"></param>
		/// <returns></returns>
		public int GetBonusType(DbArtifactBonuses.ID bonusID)
		{
			switch ((int)bonusID)
			{
				case 0:
		...
		/// <param name="bonusID"></param>
		/// <returns></returns>
		public void SetBonusAmount(DbArtifactBonuses.ID bonusID, int bonusAmount)
		{
			switch ((int)bonusID)
			{
				case 0:
		...
		/// <param name="bonusID"></param>
		/// <returns></returns>
		public void SetBonusType(DbArtifactBonuses.ID bonusID, int bonusType)
		{
			switch ((int)bonusID)
			{
				case 0:
