...
namespace DOL.Database
{
	...
	public class DbCoreCharacters : DataObject
	{
		...
		public DbCoreCharactersXCustomParam[] CustomParams;
        
        /// <summary>
        /// List of Random Number Decks for this Character
        /// </summary>
        [Relation(LocalField = "DOLCharacters_ID", RemoteField = "DOLCharactersObjectId", AutoLoad = true, AutoDelete = true)]
        public DbCoreCharactersXDeck[] RandomNumberDecks;
	}
}
