...
namespace DOL.Database
{
	...
	public class DbCoreCharacterBackup : DbCoreCharacter
	{
		...
		public DbCoreCharacterBackup()
			: base()
		{
			m_deleteDate = DateTime.Now;
		}

		public DbCoreCharacterBackup(DbCoreCharacter character)
			: base()
		{
			...
			this.CustomParams = character.CustomParams != null
				? character.CustomParams.Select(param => new DbCoreCharacterBackupXCustomParam(param.DOLCharactersObjectId, param.KeyName, param.Value)).ToArray()
				: new DbCoreCharacterBackupXCustomParam[] { } ;
		}
		...
		public new DbCoreCharacterBackupXCustomParam[] CustomParams;
	}
}
