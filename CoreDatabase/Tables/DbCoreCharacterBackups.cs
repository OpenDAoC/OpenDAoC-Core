...
namespace DOL.Database
{
	...
	public class DbCoreCharacterBackups : DbCoreCharacters
	{
		string m_dolCharactersID = string.Empty;
		private DateTime m_deleteDate;

		public DbCoreCharacterBackups()
			: base()
		{
			m_deleteDate = DateTime.Now;
		}

		public DbCoreCharacterBackups(DbCoreCharacters character)
			: base()
		{
			...
			this.CustomParams = character.CustomParams != null
				? character.CustomParams.Select(param => new DbCoreCharactersBackupXCustomParam(param.DOLCharactersObjectId, param.KeyName, param.Value)).ToArray()
				: new DbCoreCharactersBackupXCustomParam[] { } ;
		}
		...
		public new DbCoreCharactersBackupXCustomParam[] CustomParams;
	}
}
