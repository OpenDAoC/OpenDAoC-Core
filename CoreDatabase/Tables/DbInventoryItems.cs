...
namespace DOL.Database
{
	...
	public class DbInventoryItems : DataObject
	{
		...
		public DbItemTemplates ITWrapper
		{
			get { return Template.GetType() == typeof(DbItemTemplates) ? Template as DbItemTemplates : null; }
			set { if (value != null) Template = value as DbItemTemplates; }
		}

		[Relation(LocalField = "UTemplate_Id", RemoteField = "Id_nb", AutoLoad = true, AutoDelete=true)]
		public DbItemUniques IUWrapper
		{
			get { return Template.GetType() == typeof(DbItemUniques) ? Template as DbItemUniques : null; }
			set { if (value != null) Template = value; }
		}

		protected DbItemTemplates m_item;
		public virtual DbItemTemplates Template
		{
			get
			{
				if (m_item == null)
				{
					...
					return new DbItemTemplates() { AllowAdd = false };
				}
		...
		protected DbInventoryItems(DbItemTemplates template):base()
		{
			m_ownerID = null;
			Template = template;
		...
		/// </summary>
		/// <param name="itemTemplate"></param>
		protected DbInventoryItems(DbItemUniques template):base()
		{
			m_ownerID = null;
			Template = (DbItemTemplates)template;
			Template.Dirty = true;
		...
		protected DbInventoryItems(DbInventoryItems template)
		{
