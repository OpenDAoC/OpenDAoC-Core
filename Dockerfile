...
RUN git clone https://github.com/AtlasFreeshard/AtlasCore.git .
...
RUN cp DOLServer/config/serverconfig.example.xml DOLServer/config/serverconfig.xml
...
# Expose the default port for the application (change if needed)
EXPOSE 13400
