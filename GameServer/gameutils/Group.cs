...
namespace DOL.GS
{
	...
	public class Group
	{
		...
		public virtual bool AddMember(GameLiving living) 
		{
			...
			var hasGrouped = DOLDB<DbCoreCharactersXCustomParam>.SelectObject(DB.Column("DOLCharactersObjectId").IsEqualTo(player.ObjectId).And(DB.Column("KeyName").IsEqualTo(customKey)));
