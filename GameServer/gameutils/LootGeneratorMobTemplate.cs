...
namespace DOL.GS
{
	...
	public class LootGeneratorMobTemplate : LootGeneratorBase
	{
		...
		public override void Refresh(GameNPC mob)
		{
			...
			IList<DbMobDropTemplates> mxlts = DOLDB<DbMobDropTemplates>.SelectObjects(DB.Column("MobName").IsEqualTo(mob.Name));
		...
		private static LootList GenerateLootFromMobXLootTemplates(DbMobDropTemplates mobXLootTemplates, List<DbDropTemplateXItemTemplate> lootTemplates, LootList lootList, GamePlayer player)
		{
