...
namespace DOL.GS
{
	...
	public class FactionMgr
	{
		...
		public static bool Init()
		{
			...
			var dbfactionAggroLevels =	GameServer.Database.SelectAllObjects<DbFactionAggroLevels>();
			foreach(DbFactionAggroLevels dbfactionAggroLevel in dbfactionAggroLevels)
			{
