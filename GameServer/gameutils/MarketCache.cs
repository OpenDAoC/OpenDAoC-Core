...
namespace DOL.GS
{
	public class MarketCache
	{
		...
		private static Dictionary<string, DbInventoryItems> m_itemCache = null;
		...
		/// </summary>
		public static List<DbInventoryItems> Items
		{
			get { return new List<DbInventoryItems>(m_itemCache.Values); }
		}
		...
		public static bool Initialize()
		{
			...
			try
			{
				m_itemCache = new Dictionary<string, DbInventoryItems>();
				...
				var list = DOLDB<DbInventoryItems>.SelectObjects(filterBySlot.And(DB.Column("OwnerLot").IsGreatherThan(0)));

				foreach (DbInventoryItems item in list)
				{
		...
		/// <returns></returns>
		public static bool AddItem(DbInventoryItems item)
		{
			bool added = false;
		...
		/// <param name="item"></param>
		/// <returns></returns>
		public static bool RemoveItem(DbInventoryItems item)
		{
			bool removed = false;
