...
namespace DOL.GS
{
	public class MarketSearch
	{
		...
		public virtual List<DbInventoryItems> FindItemsInList(IList<DbInventoryItems> inventoryItems, SearchData search)
		{
			List<DbInventoryItems> items = new List<DbInventoryItems>();
			...
			foreach (DbInventoryItems item in inventoryItems)
			{
		...
		protected virtual bool CheckSlot(DbInventoryItems item, int slot)
		{
		...
		protected virtual bool CheckForHP(DbInventoryItems item, int hp)
		{
			if (hp > 0)
			{
		...
		protected virtual bool CheckForPower(DbInventoryItems item, int power)
		{
			if (power > 0)
			{
		...
		protected virtual bool CheckForArmorType(DbInventoryItems item, int type)
		{
			switch (type)
			{
				case 1:
		...
		protected virtual bool CheckForResist(DbInventoryItems item, int resist)
		{
			switch (resist)
			{
		...
		protected virtual bool CheckForSkill(DbInventoryItems item, int skill)
		{
			if (skill > 0)
			{
				switch (skill)
		...
		protected virtual bool CheckForBonus(DbInventoryItems item, int bonus)
		{
			if (bonus > 0)
			{
				switch (bonus)
		...
		protected virtual bool CheckForDamageType(DbInventoryItems item, int damageType)
		{
		...
		protected virtual bool CheckForProperty(DbInventoryItems item, int property)
		{
			if (property > 0)
			{
