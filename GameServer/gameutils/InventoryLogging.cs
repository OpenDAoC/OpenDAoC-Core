...
namespace DOL.GS
{
	...
	public static class InventoryLogging
	{
		...
		public static Func<DbItemTemplates, int, string> GetItemString = (item, count) =>
		...
		public static void LogInventoryAction(GameObject source, GameObject destination, eInventoryActionType type, DbItemTemplates item, int count = 1)
		{
		...
		/// <param name="type">Type of action (trade, loot, quest, ...)</param>
		/// <param name="item">The item or money account traded</param>
		public static void LogInventoryAction(string source, GameObject destination, eInventoryActionType type, DbItemTemplates item, int count = 1)
		{
		...
		/// <param name="type">Type of action (trade, loot, quest, ...)</param>
		/// <param name="item">The item or money account traded</param>
		public static void LogInventoryAction(GameObject source, string destination, eInventoryActionType type, DbItemTemplates item, int count = 1)
		{
		...
		/// <param name="type">Type of action (trade, loot, quest, ...)</param>
		/// <param name="item">The item or money account traded</param>
		public static void LogInventoryAction(string source, string destination, eInventoryActionType type, DbItemTemplates item, int count = 1)
		{
