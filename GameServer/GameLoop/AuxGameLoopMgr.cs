...
public static class AuxGameLoopMgr
{
    ...
    private static void Tick(object obj)
    {
        ...
        {
            log.Error($"Critical error encountered in {nameof(AuxGameLoopMgr)}: {e}");
        ...
        GameLoopTime = GameLoopMgr.GetCurrentTime();
        _stopwatch.Stop();
