...
namespace DOL.GS.Styles
{
    ...
    public class Style : Skill
    {
        ...
        /// </summary>
        protected DbStyles baseStyle = null;
        ...
        public Style(DbStyles style, StyleExecutedCallback callback) : base(style.Name, style.ID, (ushort)style.Icon, style.SpecLevelRequirement, style.StyleID)
        {
            baseStyle = style;
