...
namespace DOL.GS.Quests
{
	...
	public class MoneyTask : AbstractTask
	{
		...
		public MoneyTask(GamePlayer taskPlayer, DbTasks dbTask) : base(taskPlayer, dbTask)
		{			
		}
		...
		public static DbInventoryItems GenerateNPCItem(string Name, int Level)
		{			
		...
		public static bool BuildTask(GamePlayer player, GameLiving source)
		{
			...
			{
				DbInventoryItems TaskItems = GenerateNPCItem(NPC.Name, player.Level);
