...
namespace DOL.GS.Quests
{
	...
	public class DataQuest : AbstractQuest
	{
		...
		protected virtual void CheckOfferedQuestReceiveItem(GamePlayer player, GameObject obj, DbInventoryItems item)
		{
		...
		/// <param name="obj"></param>
		/// <param name="item"></param>
		protected virtual void OnPlayerGiveItem(GamePlayer player, GameObject obj, DbInventoryItems item)
		{
		...
		/// <param name="obj"></param>
		/// <param name="item"></param>
		protected virtual void OnNPCReceiveItem(GamePlayer player, GameObject obj, DbInventoryItems item)
		{
