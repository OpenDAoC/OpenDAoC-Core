		...
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			try
			{
				...
				if (e == GamePlayerEvent.EnemyKilled)
				{
					...
					// Grey mobs should not count for quest
					var targetColor = ConLevels.GetConColor(ConLevels.GetConLevel(player.EffectiveLevel, killed.EffectiveLevel));
					if (targetColor == ConColor.GREY) return;
