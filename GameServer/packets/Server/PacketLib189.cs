...
namespace DOL.GS.PacketHandler
{
	...
	public class PacketLib189 : PacketLib188
	{
		...
		public override void SendInventoryItemsUpdate(IDictionary<int, DbInventoryItems> updateItems, eInventoryWindowType windowType)
		{
			if (m_gameClient.Player == null)
				return;

			if (updateItems == null)
				updateItems = new Dictionary<int, DbInventoryItems>();
			...
			var items = new Dictionary<int, DbInventoryItems>(ServerProperties.Properties.MAX_ITEMS_PER_PACKET);
		...
		/// <param name="windowType"></param>
		protected override void SendInventoryItemsPartialUpdate(IDictionary<int, DbInventoryItems> items, eInventoryWindowType windowType)
		{
		...
		protected virtual void WriteItemData(GSTCPPacketOut pak, DbInventoryItems item)
		{
			if (item == null)
			{
				pak.Fill(0x00, 19);
