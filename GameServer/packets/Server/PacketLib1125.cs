...
namespace DOL.GS.PacketHandler
{
	...
	public class PacketLib1125 : PacketLib1124
	{
				...
				else
				{
					...
					for (int i = firstSlot; i < (firstSlot + 10); i++)
					{
						...
						else
						{
							...
							if (!itemsByOwnerID.TryGetValue(c.ObjectId, out Dictionary<eInventorySlot, DbInventoryItems> charItems))
							{
							...
							if (charItems.TryGetValue(eInventorySlot.TorsoArmor, out DbInventoryItems item))
							{
		...
		/// </summary>
		public override void SendMarketExplorerWindow(IList<DbInventoryItems> items, byte page, byte maxpage)
		{
