...
namespace DOL.GS.PacketHandler.Client.v168
{
	...
	public class PlayerRegionChangeRequestHandler : IPacketHandler
	{
		...
		public void HandlePacket(GameClient client, GSPacketIn packet)
		{
			...
			DbZonePoints zonePoint = DOLDB<DbZonePoints>.SelectObject(whereClause);
		...
		protected class RegionChangeRequestHandler : ECSGameTimerWrapperBase
		{
			...
			public RegionChangeRequestHandler(GamePlayer actionSource, DbZonePoints zonePoint, IJumpPointHandler checkHandler) : base(actionSource)
			{
