...
public class MaxPowerRequirement : ARequirement<int,Unused>
{
    ...
    public MaxPowerRequirement(GameNpc defaultNPC,  Object n, Object v, EComparator comp)
    ...
    public MaxPowerRequirement(GameNpc defaultNPC,  int n, EComparator comp)
