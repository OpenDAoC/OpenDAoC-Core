...
public class MaxHealthRequirement : ARequirement<int,Unused>
{
    ...
    public MaxHealthRequirement(GameNpc defaultNPC,  Object n, Object v, EComparator comp)
    ...
    public MaxHealthRequirement(GameNpc defaultNPC,  int n,  EComparator comp)
