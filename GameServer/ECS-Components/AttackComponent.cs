...
namespace DOL.GS
{
    public class AttackComponent : IManagedEntity
    {
        ...
        public int AttackCriticalChance(WeaponAction action, DbInventoryItems weapon)
        {
        ...
        /// </summary>
        /// <param name="weapon">attack weapon</param>
        public eDamageType AttackDamageType(DbInventoryItems weapon)
        {
            if (owner is GamePlayer || owner is CommanderPet)
            {
                ...
                switch ((eObjectType) weapon.Object_Type)
                {
                    ...
                    case eObjectType.Fired:
                        DbInventoryItems ammo = p.rangeAttackComponent.Ammo;
        ...
        public int AttackRange
        {
            ...
            get
            {
                ...
                {
                    DbInventoryItems weapon = owner.ActiveWeapon;
                    ...
                    if (weapon.SlotPosition == (int)eInventorySlot.DistanceWeapon)
                    {
                        ...
                        DbInventoryItems ammo = player.rangeAttackComponent.Ammo;
        ...
        public int AttackSpeed(DbInventoryItems mainWeapon, DbInventoryItems leftWeapon = null)
        {
        ...
        public double AttackDamage(DbInventoryItems weapon, out double damageCap)
        {
        ...
        private void StartAttack()
        {
            if (owner is GamePlayer player)
            {
                ...
                DbInventoryItems attackWeapon = owner.ActiveWeapon;
        ...
        /// </summary>
        public AttackData MakeAttack(WeaponAction action, GameObject target, DbInventoryItems weapon, Style style, double effectiveness, int interruptDuration, bool dualWield)
        {
            if (owner is GamePlayer playerOwner)
            {
                ...
                switch (ad.AttackResult)
                {
                    ...
                    case eAttackResult.Parried:
                    {
                        ...
                        if (ad.AttackResult == eAttackResult.HitStyle)
                        {
                            ...
                            DbInventoryItems attackWeapon = owner.ActiveWeapon;
                            DbInventoryItems leftWeapon = playerOwner.Inventory?.GetItem(eInventorySlot.LeftHandWeapon);
        ...
        public AttackData LivingMakeAttack(WeaponAction action, GameObject target, DbInventoryItems weapon, Style style, double effectiveness, int interruptDuration, bool dualWield, bool ignoreLOS = false)
        {
            AttackData ad = new()
            {
                Attacker = owner,
            ...
            switch (ad.AttackResult)
            {
                ...
                case eAttackResult.HitStyle:
                {
                    ...
                    DbInventoryItems armor = null;

                    if (ad.Target.Inventory != null)
                        armor = ad.Target.Inventory.GetItem((eInventorySlot) ad.ArmorHitLocation);

                    DbInventoryItems weaponForSpecModifier = null;

                    if (weapon != null)
                    {
                        weaponForSpecModifier = new DbInventoryItems();
        ...
        public double CalculateWeaponSkill(GameLiving target, DbInventoryItems weapon, double specModifier, out double baseWeaponSkill)
        {
        ...
        public double CalculateSpecModifier(GameLiving target, DbInventoryItems weapon)
        {
            double specModifier;
        ...
        public static double CalculateTargetResistance(GameLiving target, eDamageType damageType, DbInventoryItems armor)
        {
        ...
        public bool CheckGuard(AttackData ad, bool stealthStyle, double attackerConLevel)
        {
            ...
            DbInventoryItems leftHand = guard.GuardSource.Inventory.GetItem(eInventorySlot.LeftHandWeapon);
            DbInventoryItems rightHand = guard.GuardSource.ActiveWeapon;
        ...
        public bool CheckDashingDefense(AttackData ad, bool stealthStyle, double attackerConLevel, out eAttackResult result)
        {
            ...
            DbInventoryItems leftHand = dashing.GuardSource.Inventory.GetItem(eInventorySlot.LeftHandWeapon);
            DbInventoryItems rightHand = dashing.GuardSource.ActiveWeapon;
        ...
        /// </summary>
        public virtual eAttackResult CalculateEnemyAttackResult(WeaponAction action, AttackData ad, DbInventoryItems attackerWeapon)
        {
        ...
        public void SendAttackingCombatMessages(WeaponAction action, AttackData ad)
        {
            ...
            if (owner is GamePlayer)
            {
                ...
                DbInventoryItems weapon = ad.Weapon;
                if (ad.Target is GameNPC)
                {
                    switch (ad.AttackResult)
                    {
        ...
        public int CalculateMeleeCriticalDamage(AttackData ad, WeaponAction action, DbInventoryItems weapon)
        {
        ...
        public int GetMissChance(WeaponAction action, AttackData ad, AttackData lastAD, DbInventoryItems weapon)
        {
            ...
            if (ad.Target is GamePlayer p)
            {
                ...
                if (ad.Target.Inventory != null)
                {
                    DbInventoryItems armor = ad.Target.Inventory.GetItem((eInventorySlot) ad.ArmorHitLocation);
            ...
            if (action.ActiveWeaponSlot == eActiveWeaponSlot.Distance)
            {
                DbInventoryItems ammo = ad.Attacker.rangeAttackComponent.Ammo;
        ...
        public static double CalculateSlowWeaponDamageModifier(DbInventoryItems weapon)
        {
        ...
        public double CalculateTwoHandedDamageModifier(DbInventoryItems weapon)
        {
...
;
            ...
            DbInventoryItems attackWeapon = owner.ActiveWeapon;
            DbInventoryItems leftWeapon = (owner.Inventory == null) ? null : owner.Inventory.GetItem(eInventorySlot.LeftHandWeapon);
