...
{
	public class WeeklyDfKillLvl15HibQuest : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public WeeklyDfKillLvl15HibQuest() : base()
		{
		}

		public WeeklyDfKillLvl15HibQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public WeeklyDfKillLvl15HibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public WeeklyDfKillLvl15HibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Stefano.AddQuestToGive(typeof (WeeklyDfKillLvl15HibQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Stefano.RemoveQuestToGive(typeof (WeeklyDfKillLvl15HibQuest));
		}
		...
		private static void TalkToStefano(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Stefano.CanGiveQuest(typeof (WeeklyDfKillLvl15HibQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			WeeklyDfKillLvl15HibQuest quest = player.IsDoingQuest(typeof (WeeklyDfKillLvl15HibQuest)) as WeeklyDfKillLvl15HibQuest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "demonic aura":
							player.Out.SendQuestSubscribeCommand(Stefano, QuestMgr.GetIDForQuestType(typeof(WeeklyDfKillLvl15HibQuest)), "Will you help Stefano with "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (WeeklyDfKillLvl15HibQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(WeeklyDfKillLvl15HibQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Stefano.GiveQuest(typeof (WeeklyDfKillLvl15HibQuest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(WeeklyDfKillLvl15HibQuest)) == null)
				return;
