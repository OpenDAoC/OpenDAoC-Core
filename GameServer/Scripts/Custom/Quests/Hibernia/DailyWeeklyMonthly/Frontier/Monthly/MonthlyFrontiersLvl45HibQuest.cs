...
{
	public class MonthlyFrontiersLvl45HibQuest : Quests.MonthlyQuest
	{
		...
		// Constructors
		public MonthlyFrontiersLvl45HibQuest() : base()
		{
		}

		public MonthlyFrontiersLvl45HibQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public MonthlyFrontiersLvl45HibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public MonthlyFrontiersLvl45HibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Kelteen.AddQuestToGive(typeof (MonthlyFrontiersLvl45HibQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Kelteen.RemoveQuestToGive(typeof (MonthlyFrontiersLvl45HibQuest));
		}
		...
		private static void TalkToKelteen(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Kelteen.CanGiveQuest(typeof (MonthlyFrontiersLvl45HibQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			MonthlyFrontiersLvl45HibQuest quest = player.IsDoingQuest(typeof (MonthlyFrontiersLvl45HibQuest)) as MonthlyFrontiersLvl45HibQuest;
			...
			if (e == GameObjectEvent.Interact)
			{
				if (quest != null)
				{
					...
					{
						case 1:
							Kelteen.SayTo(player, $"Hello {player.PlayerClass.Name}, you will find enemies in Midgard, Albion or in our lands. " +
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "order and security":
							player.Out.SendQuestSubscribeCommand(Kelteen, QuestMgr.GetIDForQuestType(typeof(MonthlyFrontiersLvl45HibQuest)), "Will you help "+Kelteen.Name+" to slay enemies and capture keeps? " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (MonthlyFrontiersLvl45HibQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(MonthlyFrontiersLvl45HibQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Kelteen.GiveQuest(typeof (MonthlyFrontiersLvl45HibQuest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(MonthlyFrontiersLvl45HibQuest)) == null)
				return;
