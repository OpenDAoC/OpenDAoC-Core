...
{
	public class DailyOctonidKillLvl40HibQuest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public DailyOctonidKillLvl40HibQuest() : base()
		{
		}

		public DailyOctonidKillLvl40HibQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DailyOctonidKillLvl40HibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DailyOctonidKillLvl40HibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Anthony.AddQuestToGive(typeof (DailyOctonidKillLvl40HibQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Anthony.RemoveQuestToGive(typeof (DailyOctonidKillLvl40HibQuest));
		}
		...
		private static void TalkToAnthony(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Anthony.CanGiveQuest(typeof (DailyOctonidKillLvl40HibQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			DailyOctonidKillLvl40HibQuest quest = player.IsDoingQuest(typeof (DailyOctonidKillLvl40HibQuest)) as DailyOctonidKillLvl40HibQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text.ToLower())
					{
						case "clear the octonids":
							player.Out.SendQuestSubscribeCommand(Anthony, QuestMgr.GetIDForQuestType(typeof(DailyOctonidKillLvl40HibQuest)), "Will you help Anthony "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DailyOctonidKillLvl40HibQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DailyOctonidKillLvl40HibQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Anthony.GiveQuest(typeof (DailyOctonidKillLvl40HibQuest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(DailyOctonidKillLvl40HibQuest)) == null)
				return;
