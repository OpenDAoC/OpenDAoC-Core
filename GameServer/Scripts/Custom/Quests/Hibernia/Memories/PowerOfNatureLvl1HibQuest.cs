...
{
    public class PowerOfNatureLvl1HibQuest : BaseQuest
    {
        /// <summary>
        ...
        // Constructors
        public PowerOfNatureLvl1HibQuest() : base()
        {
        }

        public PowerOfNatureLvl1HibQuest(GamePlayer questingPlayer) : base(questingPlayer)
        {
        }

        public PowerOfNatureLvl1HibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
        {
        }

        public PowerOfNatureLvl1HibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            Theresa.AddQuestToGive(typeof(PowerOfNatureLvl1HibQuest));
        ...
        public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            Theresa.RemoveQuestToGive(typeof(PowerOfNatureLvl1HibQuest));
        }
        ...
        protected static void TalkToTheresa(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (Theresa.CanGiveQuest(typeof(PowerOfNatureLvl1HibQuest), player) <= 0)
                return;

            //We also check if the player is already doing the quest
            PowerOfNatureLvl1HibQuest quest = player.IsDoingQuest(typeof(PowerOfNatureLvl1HibQuest)) as PowerOfNatureLvl1HibQuest;
                    ...
                    switch (wArgs.Text)
                    {
                        case "help me":
                            player.Out.SendQuestSubscribeCommand(Theresa,
                                QuestMgr.GetIDForQuestType(typeof(PowerOfNatureLvl1HibQuest)),
        ...
        public override bool CheckQuestQualification(GamePlayer player)
        {
            ...
            if (player.IsDoingQuest(typeof(PowerOfNatureLvl1HibQuest)) != null)
                return true;
        ...
        protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(PowerOfNatureLvl1HibQuest)))
                return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            else
            {
                ...
                if (!Theresa.GiveQuest(typeof(PowerOfNatureLvl1HibQuest), player, 1))
                    return;
        ...
        public override void Notify(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (player == null || player.IsDoingQuest(typeof(PowerOfNatureLvl1HibQuest)) == null)
                return;
        }
        ...
        public class PowerOfNatureTitle : EventPlayerTitle
        {
            ...
            {
                return player.HasFinishedQuest(typeof(PowerOfNatureLvl1HibQuest)) == 1;
            }
