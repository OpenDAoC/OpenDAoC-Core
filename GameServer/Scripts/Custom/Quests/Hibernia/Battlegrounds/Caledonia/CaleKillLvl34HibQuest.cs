...
{
	public class CaleKillLvl34HibQuest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaleKillLvl34HibQuest() : base()
		{
		}

		public CaleKillLvl34HibQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public CaleKillLvl34HibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaleKillLvl34HibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.AddQuestToGive(typeof (CaleKillLvl34HibQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.RemoveQuestToGive(typeof (CaleKillLvl34HibQuest));
		}
		...
		private static void TalkToPazz(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzHib.CanGiveQuest(typeof (CaleKillLvl34HibQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaleKillLvl34HibQuest quest = player.IsDoingQuest(typeof (CaleKillLvl34HibQuest)) as CaleKillLvl34HibQuest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(PazzHib, QuestMgr.GetIDForQuestType(typeof(CaleKillLvl34HibQuest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaleKillLvl34HibQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaleKillLvl34HibQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzHib.GiveQuest(typeof (CaleKillLvl34HibQuest), player, 1))
					return;
