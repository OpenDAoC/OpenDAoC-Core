...
{
	public class CaleKeepCaptureLvl34HibQuest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaleKeepCaptureLvl34HibQuest() : base()
		{
		}

		public CaleKeepCaptureLvl34HibQuest(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public CaleKeepCaptureLvl34HibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaleKeepCaptureLvl34HibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.AddQuestToGive(typeof (CaleKeepCaptureLvl34HibQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.RemoveQuestToGive(typeof (CaleKeepCaptureLvl34HibQuest));
		}
		...
		private static void TalkToCola(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzHib.CanGiveQuest(typeof (CaleKeepCaptureLvl34HibQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaleKeepCaptureLvl34HibQuest quest = player.IsDoingQuest(typeof (CaleKeepCaptureLvl34HibQuest)) as CaleKeepCaptureLvl34HibQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help a skeleton":
							player.Out.SendQuestSubscribeCommand(PazzHib, QuestMgr.GetIDForQuestType(typeof(CaleKeepCaptureLvl34HibQuest)), "Will you help Pazz with "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaleKeepCaptureLvl34HibQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaleKeepCaptureLvl34HibQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzHib.GiveQuest(typeof (CaleKeepCaptureLvl34HibQuest), player, 1))
					return;
