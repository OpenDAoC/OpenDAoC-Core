...
{
	public class ThidKeepCaptureLvl20HibQuest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public ThidKeepCaptureLvl20HibQuest() : base()
		{
		}

		public ThidKeepCaptureLvl20HibQuest(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public ThidKeepCaptureLvl20HibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public ThidKeepCaptureLvl20HibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.AddQuestToGive(typeof (ThidKeepCaptureLvl20HibQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.RemoveQuestToGive(typeof (ThidKeepCaptureLvl20HibQuest));
		}
		...
		private static void TalkToCola(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzHib.CanGiveQuest(typeof (ThidKeepCaptureLvl20HibQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			ThidKeepCaptureLvl20HibQuest quest = player.IsDoingQuest(typeof (ThidKeepCaptureLvl20HibQuest)) as ThidKeepCaptureLvl20HibQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help a skeleton":
							player.Out.SendQuestSubscribeCommand(PazzHib, QuestMgr.GetIDForQuestType(typeof(ThidKeepCaptureLvl20HibQuest)), "Will you help Pazz with "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (ThidKeepCaptureLvl20HibQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ThidKeepCaptureLvl20HibQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzHib.GiveQuest(typeof (ThidKeepCaptureLvl20HibQuest), player, 1))
					return;
