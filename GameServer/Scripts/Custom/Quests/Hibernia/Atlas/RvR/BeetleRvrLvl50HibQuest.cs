...
{
	public class BeetleRvrLvl50HibQuest : Quests.CoreQuest
	{
		/// <summary>
		...
		// Constructors
		public BeetleRvrLvl50HibQuest() : base()
		{
		}

		public BeetleRvrLvl50HibQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public BeetleRvrLvl50HibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public BeetleRvrLvl50HibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Harris.AddQuestToGive(typeof (BeetleRvrLvl50HibQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Harris.RemoveQuestToGive(typeof (BeetleRvrLvl50HibQuest));
		}
		...
		private static void TalkToHarris(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Harris.CanGiveQuest(typeof (BeetleRvrLvl50HibQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			BeetleRvrLvl50HibQuest quest = player.IsDoingQuest(typeof (BeetleRvrLvl50HibQuest)) as BeetleRvrLvl50HibQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help Hibernia and the beetles":
							player.Out.SendQuestSubscribeCommand(Harris, QuestMgr.GetIDForQuestType(typeof(BeetleRvrLvl50HibQuest)), "Will you help Harris "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (BeetleRvrLvl50HibQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(BeetleRvrLvl50HibQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Harris.GiveQuest(typeof (BeetleRvrLvl50HibQuest), player, 1))
					return;
