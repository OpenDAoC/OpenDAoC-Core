...
{
	public class CaleKillLvl34MidQuest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaleKillLvl34MidQuest() : base()
		{
		}

		public CaleKillLvl34MidQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public CaleKillLvl34MidQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaleKillLvl34MidQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzMid.AddQuestToGive(typeof (CaleKillLvl34MidQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzMid.RemoveQuestToGive(typeof (CaleKillLvl34MidQuest));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzMid.CanGiveQuest(typeof (CaleKillLvl34MidQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaleKillLvl34MidQuest quest = player.IsDoingQuest(typeof (CaleKillLvl34MidQuest)) as CaleKillLvl34MidQuest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(PazzMid, QuestMgr.GetIDForQuestType(typeof(CaleKillLvl34MidQuest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaleKillLvl34MidQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaleKillLvl34MidQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzMid.GiveQuest(typeof (CaleKillLvl34MidQuest), player, 1))
					return;
