...
{
	public class CaleKeepCaptureLvl34MidQuest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaleKeepCaptureLvl34MidQuest() : base()
		{
		}

		public CaleKeepCaptureLvl34MidQuest(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public CaleKeepCaptureLvl34MidQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaleKeepCaptureLvl34MidQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzMid.AddQuestToGive(typeof (CaleKeepCaptureLvl34MidQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzMid.RemoveQuestToGive(typeof (CaleKeepCaptureLvl34MidQuest));
		}
		...
		private static void TalkToHerou(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzMid.CanGiveQuest(typeof (CaleKeepCaptureLvl34MidQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaleKeepCaptureLvl34MidQuest quest = player.IsDoingQuest(typeof (CaleKeepCaptureLvl34MidQuest)) as CaleKeepCaptureLvl34MidQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help a skeleton":
							player.Out.SendQuestSubscribeCommand(PazzMid, QuestMgr.GetIDForQuestType(typeof(CaleKeepCaptureLvl34MidQuest)), "Will you help Pazz with "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaleKeepCaptureLvl34MidQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaleKeepCaptureLvl34MidQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzMid.GiveQuest(typeof (CaleKeepCaptureLvl34MidQuest), player, 1))
					return;
