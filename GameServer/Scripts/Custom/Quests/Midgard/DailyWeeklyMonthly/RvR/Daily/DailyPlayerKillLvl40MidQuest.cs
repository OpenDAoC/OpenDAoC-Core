...
{
	public class DailyPlayerKillLvl40MidQuest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public DailyPlayerKillLvl40MidQuest() : base()
		{
		}

		public DailyPlayerKillLvl40MidQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DailyPlayerKillLvl40MidQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DailyPlayerKillLvl40MidQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.AddQuestToGive(typeof (DailyPlayerKillLvl40MidQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.RemoveQuestToGive(typeof (DailyPlayerKillLvl40MidQuest));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyMid.CanGiveQuest(typeof (DailyPlayerKillLvl40MidQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			DailyPlayerKillLvl40MidQuest quest = player.IsDoingQuest(typeof (DailyPlayerKillLvl40MidQuest)) as DailyPlayerKillLvl40MidQuest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(ReyMid, QuestMgr.GetIDForQuestType(typeof(DailyPlayerKillLvl40MidQuest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DailyPlayerKillLvl40MidQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DailyPlayerKillLvl40MidQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyMid.GiveQuest(typeof (DailyPlayerKillLvl40MidQuest), player, 1))
					return;
