...
{
	public class BeetleRvrLvl50MidQuest : Quests.CoreQuest
	{
		/// <summary>
		...
		// Constructors
		public BeetleRvrLvl50MidQuest() : base()
		{
		}

		public BeetleRvrLvl50MidQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public BeetleRvrLvl50MidQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public BeetleRvrLvl50MidQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Rengahr.AddQuestToGive(typeof (BeetleRvrLvl50MidQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Rengahr.RemoveQuestToGive(typeof (BeetleRvrLvl50MidQuest));
		}
		...
		private static void TalkToHarris(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Rengahr.CanGiveQuest(typeof (BeetleRvrLvl50MidQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			BeetleRvrLvl50MidQuest quest = player.IsDoingQuest(typeof (BeetleRvrLvl50MidQuest)) as BeetleRvrLvl50MidQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help Midgard and the beetles":
							player.Out.SendQuestSubscribeCommand(Rengahr, QuestMgr.GetIDForQuestType(typeof(BeetleRvrLvl50MidQuest)), "Will you help Rengahr "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (BeetleRvrLvl50MidQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(BeetleRvrLvl50MidQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Rengahr.GiveQuest(typeof (BeetleRvrLvl50MidQuest), player, 1))
					return;
