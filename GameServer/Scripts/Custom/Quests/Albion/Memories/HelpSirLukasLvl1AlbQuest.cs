...
namespace Core.GS.Quests.Albion
{
	public class HelpSirLukasLvl1AlbQuest : BaseQuest
	{
		...
		// Constructors
		public HelpSirLukasLvl1AlbQuest() : base()
		{
		}

		public HelpSirLukasLvl1AlbQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public HelpSirLukasLvl1AlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public HelpSirLukasLvl1AlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (graveCheck.Count == 0)
			{
				...
				if (SAVE_INTO_DATABASE)
				{
					...
					HelpSirLukasLvl1AlbQuest.FlitzitinasGrave = FlitzitinasGrave;
				}
			...
			SirLukas.AddQuestToGive(typeof (HelpSirLukasLvl1AlbQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SirLukas.RemoveQuestToGive(typeof (HelpSirLukasLvl1AlbQuest));
		}
		...
		protected static void TalkToSirLukas(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(SirLukas.CanGiveQuest(typeof (HelpSirLukasLvl1AlbQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			HelpSirLukasLvl1AlbQuest quest = player.IsDoingQuest(typeof (HelpSirLukasLvl1AlbQuest)) as HelpSirLukasLvl1AlbQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "support Camelot":
							player.Out.SendQuestSubscribeCommand(SirLukas, QuestMgr.GetIDForQuestType(typeof(HelpSirLukasLvl1AlbQuest)), "Will you help Sir Lukas [Memorial] All in the Gold]?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (HelpSirLukasLvl1AlbQuest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(HelpSirLukasLvl1AlbQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!SirLukas.GiveQuest(typeof (HelpSirLukasLvl1AlbQuest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player==null || player.IsDoingQuest(typeof (HelpSirLukasLvl1AlbQuest)) == null)
				return;
		...
		public class HelpSirLukasTitle : EventPlayerTitle 
    {
        ...
        {
	        return player.HasFinishedQuest(typeof(HelpSirLukasLvl1AlbQuest)) == 1;
        }
