...
{
	public class HardcoreKillAPlayerLvl1AlbQuest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public HardcoreKillAPlayerLvl1AlbQuest() : base()
		{
		}

		public HardcoreKillAPlayerLvl1AlbQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public HardcoreKillAPlayerLvl1AlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public HardcoreKillAPlayerLvl1AlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciAlb.AddQuestToGive(typeof (HardcoreKillAPlayerLvl1AlbQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciAlb.RemoveQuestToGive(typeof (HardcoreKillAPlayerLvl1AlbQuest));
		}
		...
		private static void TalkToSucci(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(SucciAlb.CanGiveQuest(typeof (HardcoreKillAPlayerLvl1AlbQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			HardcoreKillAPlayerLvl1AlbQuest oranges = player.IsDoingQuest(typeof (HardcoreKillAPlayerLvl1AlbQuest)) as HardcoreKillAPlayerLvl1AlbQuest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (oranges == null)
				{
					...
					{
						case "predator":
							player.Out.SendQuestSubscribeCommand(SucciAlb, QuestMgr.GetIDForQuestType(typeof(HardcoreKillAPlayerLvl1AlbQuest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (HardcoreKillAPlayerLvl1AlbQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(HardcoreKillAPlayerLvl1AlbQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!SucciAlb.GiveQuest(typeof (HardcoreKillAPlayerLvl1AlbQuest), player, 1))
					return;
