...
{
	public class WeeklyForTheRealmLvl40AlbQuest : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public WeeklyForTheRealmLvl40AlbQuest() : base()
		{
		}

		public WeeklyForTheRealmLvl40AlbQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public WeeklyForTheRealmLvl40AlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public WeeklyForTheRealmLvl40AlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.AddQuestToGive(typeof (WeeklyForTheRealmLvl40AlbQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.RemoveQuestToGive(typeof (WeeklyForTheRealmLvl40AlbQuest));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyAlb.CanGiveQuest(typeof (WeeklyForTheRealmLvl40AlbQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			WeeklyForTheRealmLvl40AlbQuest quest = player.IsDoingQuest(typeof (WeeklyForTheRealmLvl40AlbQuest)) as WeeklyForTheRealmLvl40AlbQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "bunch of toeknuckles":
							player.Out.SendQuestSubscribeCommand(ReyAlb, QuestMgr.GetIDForQuestType(typeof(WeeklyForTheRealmLvl40AlbQuest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (WeeklyForTheRealmLvl40AlbQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(WeeklyForTheRealmLvl40AlbQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyAlb.GiveQuest(typeof (WeeklyForTheRealmLvl40AlbQuest), player, 1))
					return;
