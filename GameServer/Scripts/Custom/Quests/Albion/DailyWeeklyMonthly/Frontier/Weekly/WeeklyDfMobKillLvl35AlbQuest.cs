...
{
	public class WeeklyDfMobKillLvl35AlbQuest : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public WeeklyDfMobKillLvl35AlbQuest() : base()
		{
		}

		public WeeklyDfMobKillLvl35AlbQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public WeeklyDfMobKillLvl35AlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public WeeklyDfMobKillLvl35AlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Joe.AddQuestToGive(typeof (WeeklyDfMobKillLvl35AlbQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Joe.RemoveQuestToGive(typeof (WeeklyDfMobKillLvl35AlbQuest));
		}
		...
		private static void TalkToJoe(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Joe.CanGiveQuest(typeof (WeeklyDfMobKillLvl35AlbQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			WeeklyDfMobKillLvl35AlbQuest quest = player.IsDoingQuest(typeof (WeeklyDfMobKillLvl35AlbQuest)) as WeeklyDfMobKillLvl35AlbQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "stop the invasion":
							player.Out.SendQuestSubscribeCommand(Joe, QuestMgr.GetIDForQuestType(typeof(WeeklyDfMobKillLvl35AlbQuest)), "Will you help Joe "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (WeeklyDfMobKillLvl35AlbQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(WeeklyDfMobKillLvl35AlbQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Joe.GiveQuest(typeof (WeeklyDfMobKillLvl35AlbQuest), player, 1))
					return;
