...
{
	public class WeeklyEpicRvrMobsLvl50AlbQuest : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public WeeklyEpicRvrMobsLvl50AlbQuest() : base()
		{
		}

		public WeeklyEpicRvrMobsLvl50AlbQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public WeeklyEpicRvrMobsLvl50AlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public WeeklyEpicRvrMobsLvl50AlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Haszan.AddQuestToGive(typeof (WeeklyEpicRvrMobsLvl50AlbQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Haszan.RemoveQuestToGive(typeof (WeeklyEpicRvrMobsLvl50AlbQuest));
		}
		...
		private static void TalkToHaszan(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Haszan.CanGiveQuest(typeof (WeeklyEpicRvrMobsLvl50AlbQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			WeeklyEpicRvrMobsLvl50AlbQuest quest = player.IsDoingQuest(typeof (WeeklyEpicRvrMobsLvl50AlbQuest)) as WeeklyEpicRvrMobsLvl50AlbQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "kill the epic creatures":
							player.Out.SendQuestSubscribeCommand(Haszan, QuestMgr.GetIDForQuestType(typeof(WeeklyEpicRvrMobsLvl50AlbQuest)), "Will you help Haszan "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (WeeklyEpicRvrMobsLvl50AlbQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(WeeklyEpicRvrMobsLvl50AlbQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Haszan.GiveQuest(typeof (WeeklyEpicRvrMobsLvl50AlbQuest), player, 1))
					return;
