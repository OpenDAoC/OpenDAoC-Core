...
{
	public class MonthlyCaptureRelicLvl50AlbQuest : Quests.MonthlyQuest
	{
		/// <summary>
		...
		// Constructors
		public MonthlyCaptureRelicLvl50AlbQuest() : base()
		{
		}

		public MonthlyCaptureRelicLvl50AlbQuest(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public MonthlyCaptureRelicLvl50AlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public MonthlyCaptureRelicLvl50AlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Kelteen.AddQuestToGive(typeof (MonthlyCaptureRelicLvl50AlbQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Kelteen.RemoveQuestToGive(typeof (MonthlyCaptureRelicLvl50AlbQuest));
		}
		...
		private static void TalkToKelteen(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Kelteen.CanGiveQuest(typeof (MonthlyCaptureRelicLvl50AlbQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			MonthlyCaptureRelicLvl50AlbQuest quest = player.IsDoingQuest(typeof (MonthlyCaptureRelicLvl50AlbQuest)) as MonthlyCaptureRelicLvl50AlbQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "securing a foothold":
							player.Out.SendQuestSubscribeCommand(Kelteen, QuestMgr.GetIDForQuestType(typeof(MonthlyCaptureRelicLvl50AlbQuest)), "Will you help Kelteen "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (MonthlyCaptureRelicLvl50AlbQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(MonthlyCaptureRelicLvl50AlbQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Kelteen.GiveQuest(typeof (MonthlyCaptureRelicLvl50AlbQuest), player, 1))
					return;
