...
{
	public class ThidKeepCaptureLvl20AlbQuest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public ThidKeepCaptureLvl20AlbQuest() : base()
		{
		}

		public ThidKeepCaptureLvl20AlbQuest(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public ThidKeepCaptureLvl20AlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public ThidKeepCaptureLvl20AlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzAlb.AddQuestToGive(typeof (ThidKeepCaptureLvl20AlbQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzAlb.RemoveQuestToGive(typeof (ThidKeepCaptureLvl20AlbQuest));
		}
		...
		private static void TalkToHaszan(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzAlb.CanGiveQuest(typeof (ThidKeepCaptureLvl20AlbQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			ThidKeepCaptureLvl20AlbQuest quest = player.IsDoingQuest(typeof (ThidKeepCaptureLvl20AlbQuest)) as ThidKeepCaptureLvl20AlbQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help a skeleton":
							player.Out.SendQuestSubscribeCommand(PazzAlb, QuestMgr.GetIDForQuestType(typeof(ThidKeepCaptureLvl20AlbQuest)), "Will you help Pazz with "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (ThidKeepCaptureLvl20AlbQuest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ThidKeepCaptureLvl20AlbQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzAlb.GiveQuest(typeof (ThidKeepCaptureLvl20AlbQuest), player, 1))
					return;
