...
{
	public class ThidKillLvl20AlbQuest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public ThidKillLvl20AlbQuest() : base()
		{
		}

		public ThidKillLvl20AlbQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public ThidKillLvl20AlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public ThidKillLvl20AlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzAlb.AddQuestToGive(typeof (ThidKillLvl20AlbQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzAlb.RemoveQuestToGive(typeof (ThidKillLvl20AlbQuest));
		}
		...
		protected static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzAlb.CanGiveQuest(typeof (ThidKillLvl20AlbQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			ThidKillLvl20AlbQuest quest = player.IsDoingQuest(typeof (ThidKillLvl20AlbQuest)) as ThidKillLvl20AlbQuest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(PazzAlb, QuestMgr.GetIDForQuestType(typeof(ThidKillLvl20AlbQuest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (ThidKillLvl20AlbQuest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ThidKillLvl20AlbQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzAlb.GiveQuest(typeof (ThidKillLvl20AlbQuest), player, 1))
					return;
