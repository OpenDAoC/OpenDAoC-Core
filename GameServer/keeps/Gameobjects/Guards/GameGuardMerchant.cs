...
namespace DOL.GS
{
	...
	public class GameGuardMerchant : GameKeepGuard
	{
		...
		public virtual void OnPlayerSell(GamePlayer player, DbInventoryItems item)
		{
		...
		public virtual long OnPlayerAppraise(GamePlayer player, DbInventoryItems item, bool silent)
		{
			if (item == null)
				return 0;
