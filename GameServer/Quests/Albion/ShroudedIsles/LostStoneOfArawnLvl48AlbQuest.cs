...
public class LostStoneOfArawnLvl48AlbQuest : BaseQuest
{
    ...
    // Constructors
    public LostStoneOfArawnLvl48AlbQuest()
    {
    }

    public LostStoneOfArawnLvl48AlbQuest(GamePlayer questingPlayer) : base(questingPlayer)
    {
    }

    public LostStoneOfArawnLvl48AlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
    {
    }

    public LostStoneOfArawnLvl48AlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
    {
    }
    ...
    public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
    {
        ...
        Honaytrt.AddQuestToGive(typeof(LostStoneOfArawnLvl48AlbQuest));
    ...
    public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
    {
        ...
        Honaytrt.RemoveQuestToGive(typeof(LostStoneOfArawnLvl48AlbQuest));
    }
    ...
    {
        var quest = player.IsDoingQuest(typeof(LostStoneOfArawnLvl48AlbQuest)) as LostStoneOfArawnLvl48AlbQuest;
    ...
    private static void TalkToHonaytrt(CoreEvent e, object sender, EventArgs args)
    {
        ...
        if (Honaytrt.CanGiveQuest(typeof(LostStoneOfArawnLvl48AlbQuest), player) <= 0)
            return;
                ...
                switch (wArgs.Text)
                {
                    case "help me":
                        player.Out.SendQuestSubscribeCommand(Honaytrt,
                            QuestMgr.GetIDForQuestType(typeof(LostStoneOfArawnLvl48AlbQuest)),
    ...
    public override bool CheckQuestQualification(GamePlayer player)
    {
        ...
        if (player.IsDoingQuest(typeof(LostStoneOfArawnLvl48AlbQuest)) != null)
            return true;
    ...
    private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
    {
        ...
        if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(LostStoneOfArawnLvl48AlbQuest)))
            return;
    ...
    private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
    {
        ...
        else
        {
            ...
            if (!Honaytrt.GiveQuest(typeof(LostStoneOfArawnLvl48AlbQuest), player, 1))
                return;
