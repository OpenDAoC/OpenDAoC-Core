...
namespace Core.GS.Quests.Hibernia
{
    public class WildWildernessLvl1AlbQuest : BaseQuest
    {
        ...
        public WildWildernessLvl1AlbQuest() : base() { }
        public WildWildernessLvl1AlbQuest(GamePlayer questingPlayer) : base(questingPlayer) { }
        public WildWildernessLvl1AlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step) { }
        public WildWildernessLvl1AlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest) { }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            _miach.AddQuestToGive(typeof(WildWildernessLvl1AlbQuest));
        ...
        public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            _miach.RemoveQuestToGive(typeof(WildWildernessLvl1AlbQuest));
        }
        ...
        protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(WildWildernessLvl1AlbQuest)))
            {
                return;
            }
        ...
        private static void TalkToMiach(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (_miach.CanGiveQuest(typeof(WildWildernessLvl1AlbQuest), player) <= 0)
                return;
            
            WildWildernessLvl1AlbQuest quest = player.IsDoingQuest(typeof(WildWildernessLvl1AlbQuest)) as WildWildernessLvl1AlbQuest;
                ...
                if (quest == null)
                {
                    switch (wArgs.Text)
                    {
                        case "hunt":
                            ...
                            player.Out.SendQuestSubscribeCommand(_miach, QuestMgr.GetIDForQuestType(typeof(WildWildernessLvl1AlbQuest)), "Will you help rid the area of young lungers?");
                            break;
                    }
                }
                else
        ...
        public override void Notify(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (player?.IsDoingQuest(typeof(WildWildernessLvl1AlbQuest)) == null)
                return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            {
                if (!_miach.GiveQuest(typeof(WildWildernessLvl1AlbQuest), player, 1))
                    return;
