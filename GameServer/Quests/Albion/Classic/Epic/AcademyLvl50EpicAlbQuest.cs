...
{
	public class AcademyLvl50EpicAlbQuest : BaseQuest
	{
		/// <summary>
		...
		// Constructors
		public AcademyLvl50EpicAlbQuest() : base()
		{
		}

		public AcademyLvl50EpicAlbQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public AcademyLvl50EpicAlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public AcademyLvl50EpicAlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
...
//end item
			...
			Ferowl.AddQuestToGive(typeof (AcademyLvl50EpicAlbQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Ferowl.RemoveQuestToGive(typeof (AcademyLvl50EpicAlbQuest));
		}
...
//				Morgana.AddNPCEquipment((byte) eVisibleItems.BOOT, 133, 61, 0, 0);
		...
		protected static void TalkToFerowl(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Ferowl.CanGiveQuest(typeof (AcademyLvl50EpicAlbQuest), player)  <= 0)
				return;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "services":
							player.Out.SendQuestSubscribeCommand(Ferowl, QuestMgr.GetIDForQuestType(typeof(AcademyLvl50EpicAlbQuest)), "Will you help Ferowl [Academy Level 50 Epic]");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (AcademyLvl50EpicAlbQuest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(AcademyLvl50EpicAlbQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Ferowl.GiveQuest(typeof (AcademyLvl50EpicAlbQuest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player==null || player.IsDoingQuest(typeof (AcademyLvl50EpicAlbQuest)) == null)
				return;
