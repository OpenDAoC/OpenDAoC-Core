...
{
	public class DefendersLvl50EpicAlbQuest : BaseQuest
	{
		/// <summary>
		...
		// Constructors
		public DefendersLvl50EpicAlbQuest() : base()
		{
		}

		public DefendersLvl50EpicAlbQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DefendersLvl50EpicAlbQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DefendersLvl50EpicAlbQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Lidmann.AddQuestToGive(typeof(DefendersLvl50EpicAlbQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Lidmann.RemoveQuestToGive(typeof (DefendersLvl50EpicAlbQuest));
		}
		...
		protected static void TalkToLidmann(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (Lidmann.CanGiveQuest(typeof(DefendersLvl50EpicAlbQuest), player) <= 0)
				return;
			...
			DefendersLvl50EpicAlbQuest quest = player.IsDoingQuest(typeof (DefendersLvl50EpicAlbQuest)) as DefendersLvl50EpicAlbQuest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "services":
							player.Out.SendQuestSubscribeCommand(Lidmann, QuestMgr.GetIDForQuestType(typeof(DefendersLvl50EpicAlbQuest)), "Will you help Lidmann [Defenders of Albion Level 50 Epic]?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DefendersLvl50EpicAlbQuest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DefendersLvl50EpicAlbQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Lidmann.GiveQuest(typeof (DefendersLvl50EpicAlbQuest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player==null || player.IsDoingQuest(typeof (DefendersLvl50EpicAlbQuest)) == null)
				return;
