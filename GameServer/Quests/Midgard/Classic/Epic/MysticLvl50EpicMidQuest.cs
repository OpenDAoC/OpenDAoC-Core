...
{
	public class MysticLvl50EpicMidQuest : BaseQuest
	{
		...
		// Constructors
		public MysticLvl50EpicMidQuest() : base()
		{
		}

		public MysticLvl50EpicMidQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public MysticLvl50EpicMidQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public MysticLvl50EpicMidQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
...
//end item
			...
			Danica.AddQuestToGive(typeof (MysticLvl50EpicMidQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Danica.RemoveQuestToGive(typeof (MysticLvl50EpicMidQuest));
		}
		...
		protected static void TalkToDanica(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Danica.CanGiveQuest(typeof (MysticLvl50EpicMidQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			MysticLvl50EpicMidQuest quest = player.IsDoingQuest(typeof (MysticLvl50EpicMidQuest)) as MysticLvl50EpicMidQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "worries me":
							...
							break;
						case "face Kelic":
							player.Out.SendQuestSubscribeCommand(Danica, QuestMgr.GetIDForQuestType(typeof(MysticLvl50EpicMidQuest)), "Will you face Kelic [Mystic Level 50 Epic]?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (MysticLvl50EpicMidQuest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(MysticLvl50EpicMidQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Danica.GiveQuest(typeof (MysticLvl50EpicMidQuest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player==null || player.IsDoingQuest(typeof (MysticLvl50EpicMidQuest)) == null)
				return;
