...
{
	public class VikingLvl50EpicMidQuest : BaseQuest
	{
		...
		// Constructors
		public VikingLvl50EpicMidQuest() : base()
		{
		}

		public VikingLvl50EpicMidQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public VikingLvl50EpicMidQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public VikingLvl50EpicMidQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
...
//Item Descriptions End
			...
			Lynnleigh.AddQuestToGive(typeof (VikingLvl50EpicMidQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Lynnleigh.RemoveQuestToGive(typeof (VikingLvl50EpicMidQuest));
		}
		...
		protected static void TalkToLynnleigh(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Lynnleigh.CanGiveQuest(typeof (VikingLvl50EpicMidQuest), player)  <= 0)
				return;
			...
			VikingLvl50EpicMidQuest quest = player.IsDoingQuest(typeof (VikingLvl50EpicMidQuest)) as VikingLvl50EpicMidQuest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "worries me":
							...
							break;
						case "face Ydenia":
							player.Out.SendQuestSubscribeCommand(Lynnleigh, QuestMgr.GetIDForQuestType(typeof(VikingLvl50EpicMidQuest)), "Will you face Ydenia [Viking Level 50 Epic]?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (VikingLvl50EpicMidQuest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(VikingLvl50EpicMidQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Lynnleigh.GiveQuest(typeof (VikingLvl50EpicMidQuest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player==null || player.IsDoingQuest(typeof (VikingLvl50EpicMidQuest)) == null)
				return;
