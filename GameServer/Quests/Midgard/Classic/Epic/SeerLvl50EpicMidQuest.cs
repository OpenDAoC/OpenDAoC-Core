...
{
	public class SeerLvl50EpicMidQuest : BaseQuest
	{
		...
		// Constructors
		public SeerLvl50EpicMidQuest() : base()
		{
		}

		public SeerLvl50EpicMidQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public SeerLvl50EpicMidQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public SeerLvl50EpicMidQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
...
//Item Descriptions End
			...
			Inaksha.AddQuestToGive(typeof (SeerLvl50EpicMidQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Inaksha.RemoveQuestToGive(typeof (SeerLvl50EpicMidQuest));
		}
		...
		protected static void TalkToInaksha(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Inaksha.CanGiveQuest(typeof (SeerLvl50EpicMidQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			SeerLvl50EpicMidQuest quest = player.IsDoingQuest(typeof (SeerLvl50EpicMidQuest)) as SeerLvl50EpicMidQuest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "services":
							player.Out.SendQuestSubscribeCommand(Inaksha, QuestMgr.GetIDForQuestType(typeof(SeerLvl50EpicMidQuest)), "Will you help Inaksha [Seer Level 50 Epic]?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (SeerLvl50EpicMidQuest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(SeerLvl50EpicMidQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Inaksha.GiveQuest(typeof (SeerLvl50EpicMidQuest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(SeerLvl50EpicMidQuest)) == null)
				return;
