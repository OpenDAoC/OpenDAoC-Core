...
namespace Core.GS.Quests
{
    public class ATask
    {
        ...
        public ATask(GamePlayer taskPlayer)
        {
        ...
        public ATask(GamePlayer taskPlayer, DbTask dbTask)
        {
            m_taskPlayer = taskPlayer;
            m_dbTask = dbTask;
            ParseCustomProperties();
        ...
        public bool TaskActive
        {
            get
            {
                return !string.IsNullOrEmpty(m_dbTask.TaskType) &&
                       m_dbTask.TaskType != typeof(ATask).ToString();
            }
        }
        ...
        public static ATask LoadFromDatabase(GamePlayer targetPlayer, DbTask dbTask)
        {
            ...
            if (!string.IsNullOrEmpty(dbTask.TaskType))
            {
                ...
                return (ATask) Activator.CreateInstance(taskType, new object[] {targetPlayer, dbTask});
            }
            else
            {
                return null;
