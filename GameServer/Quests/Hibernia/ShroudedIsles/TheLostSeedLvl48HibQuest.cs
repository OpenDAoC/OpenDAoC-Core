...
namespace Core.GS.Quests.Hibernia
{
	public class TheLostSeedLvl48HibQuest : BaseQuest
	{
		...
		// Constructors
		public TheLostSeedLvl48HibQuest() : base()
		{
		}

		public TheLostSeedLvl48HibQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public TheLostSeedLvl48HibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public TheLostSeedLvl48HibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
        ...
        // end npc
			...
			Terod?.AddQuestToGive(typeof (TheLostSeedLvl48HibQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Terod.RemoveQuestToGive(typeof (TheLostSeedLvl48HibQuest));
		}
		...
		{
			var quest = player.IsDoingQuest(typeof(TheLostSeedLvl48HibQuest)) as TheLostSeedLvl48HibQuest;
		...
		protected static void TalkToTerod(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Terod.CanGiveQuest(typeof (TheLostSeedLvl48HibQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			TheLostSeedLvl48HibQuest quest = player.IsDoingQuest(typeof (TheLostSeedLvl48HibQuest)) as TheLostSeedLvl48HibQuest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						...
						case "Lost Seed":
							player.Out.SendQuestSubscribeCommand(Terod, QuestMgr.GetIDForQuestType(typeof(TheLostSeedLvl48HibQuest)), "Will you help Terod find [The Lost Seed]?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (TheLostSeedLvl48HibQuest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(TheLostSeedLvl48HibQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Terod.GiveQuest(typeof (TheLostSeedLvl48HibQuest), player, 1))
					return;
			}
