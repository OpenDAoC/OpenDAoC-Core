...
public class WildWildernessLvl1HibQuest : BaseQuest
{
    ...
    public WildWildernessLvl1HibQuest() : base() { }
    public WildWildernessLvl1HibQuest(GamePlayer questingPlayer) : base(questingPlayer) { }
    public WildWildernessLvl1HibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step) { }
    public WildWildernessLvl1HibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest) { }
    ...
    public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
    {
        ...
        _miach.AddQuestToGive(typeof(WildWildernessLvl1HibQuest));
    ...
    public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
    {
        ...
        _miach.RemoveQuestToGive(typeof(WildWildernessLvl1HibQuest));
    }
    ...
    protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
    {
        ...
        if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(WildWildernessLvl1HibQuest)))
        {
            return;
        }
    ...
    private static void TalkToMiach(CoreEvent e, object sender, EventArgs args)
    {
        ...
        if (_miach.CanGiveQuest(typeof(WildWildernessLvl1HibQuest), player) <= 0)
            return;
        
        WildWildernessLvl1HibQuest quest = player.IsDoingQuest(typeof(WildWildernessLvl1HibQuest)) as WildWildernessLvl1HibQuest;
            ...
            if (quest == null)
            {
                switch (wArgs.Text)
                {
                    case "hunt":
                        ...
                        player.Out.SendQuestSubscribeCommand(_miach, QuestMgr.GetIDForQuestType(typeof(WildWildernessLvl1HibQuest)), "Will you help rid the area of young lungers?");
                        break;
                }
            }
            else
    ...
    public override void Notify(CoreEvent e, object sender, EventArgs args)
    {
        ...
        if (player?.IsDoingQuest(typeof(WildWildernessLvl1HibQuest)) == null)
            return;
    ...
    private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
    {
        ...
        {
            if (!_miach.GiveQuest(typeof(WildWildernessLvl1HibQuest), player, 1))
                return;
