...
{
	public class EssenceLvl50EpicHibQuest : BaseQuest
	{
		...
		// Constructors
		public EssenceLvl50EpicHibQuest() : base()
		{
		}

		public EssenceLvl50EpicHibQuest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public EssenceLvl50EpicHibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public EssenceLvl50EpicHibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
		{
		}
...
//Item Descriptions End
			...
			Brigit.AddQuestToGive(typeof (EssenceLvl50EpicHibQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Brigit.RemoveQuestToGive(typeof (EssenceLvl50EpicHibQuest));
		}
		...
		protected static void TalkToBrigit(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Brigit.CanGiveQuest(typeof (EssenceLvl50EpicHibQuest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			EssenceLvl50EpicHibQuest quest = player.IsDoingQuest(typeof (EssenceLvl50EpicHibQuest)) as EssenceLvl50EpicHibQuest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "services":
							player.Out.SendQuestSubscribeCommand(Brigit, QuestMgr.GetIDForQuestType(typeof(EssenceLvl50EpicHibQuest)), "Will you help Brigit [Path of Essence Level 50 Epic]?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (EssenceLvl50EpicHibQuest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(EssenceLvl50EpicHibQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Brigit.GiveQuest(typeof (EssenceLvl50EpicHibQuest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player==null || player.IsDoingQuest(typeof (EssenceLvl50EpicHibQuest)) == null)
				return;
