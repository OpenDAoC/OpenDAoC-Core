...
public class FocusLvl50EpicHibQuest : BaseQuest
{
	...
	// Constructors
	public FocusLvl50EpicHibQuest() : base()
	{
	}

	public FocusLvl50EpicHibQuest(GamePlayer questingPlayer) : base(questingPlayer)
	{
	}

	public FocusLvl50EpicHibQuest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
	{
	}

	public FocusLvl50EpicHibQuest(GamePlayer questingPlayer, DbQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
...
//Item Descriptions End
		...
		Ainrebh.AddQuestToGive(typeof (FocusLvl50EpicHibQuest));
	...
	public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
	{
		...
		Ainrebh.RemoveQuestToGive(typeof (FocusLvl50EpicHibQuest));
	}
	...
	protected static void TalkToAinrebh(CoreEvent e, object sender, EventArgs args)
	{
		...
		if (Ainrebh.CanGiveQuest(typeof (FocusLvl50EpicHibQuest), player)  <= 0)
			return;
		...
		FocusLvl50EpicHibQuest quest = player.IsDoingQuest(typeof (FocusLvl50EpicHibQuest)) as FocusLvl50EpicHibQuest;
		...
		else if (e == GameLivingEvent.WhisperReceive)
		{
			...
			if (quest == null)
			{
				...
				{
					case "services":
						player.Out.SendQuestSubscribeCommand(Ainrebh, QuestMgr.GetIDForQuestType(typeof(FocusLvl50EpicHibQuest)), "Will you help Ainrebh [Path of Focus Level 50 Epic]?");
						break;
				}
			}
			else
	...
	public override bool CheckQuestQualification(GamePlayer player)
	{
		...
		if (player.IsDoingQuest(typeof (FocusLvl50EpicHibQuest)) != null)
			return true;
	...
	protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
	{
		...
		if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(FocusLvl50EpicHibQuest)))
			return;
	...
	private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
	{
		...
		else
		{
			...
			if (!Ainrebh.GiveQuest(typeof (FocusLvl50EpicHibQuest), player, 1))
				return;
	...
	public override void Notify(CoreEvent e, object sender, EventArgs args)
	{
		...
		if (player==null || player.IsDoingQuest(typeof (FocusLvl50EpicHibQuest)) == null)
			return;
