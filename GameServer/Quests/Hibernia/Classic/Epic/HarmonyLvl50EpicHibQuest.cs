...
namespace Core.GS.Quests.Hibernia
{
	public class HarmonyLvl50EpicHibQuest : BaseQuest
	{
		...
		// Constructors
		public HarmonyLvl50EpicHibQuest()
			: base()
		{
		}

		public HarmonyLvl50EpicHibQuest(GamePlayer questingPlayer)
			: base(questingPlayer)
		{
		}

		public HarmonyLvl50EpicHibQuest(GamePlayer questingPlayer, int step)
			: base(questingPlayer, step)
		{
		}

		public HarmonyLvl50EpicHibQuest(GamePlayer questingPlayer, DbQuest dbQuest)
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Revelin.AddQuestToGive(typeof(HarmonyLvl50EpicHibQuest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Revelin.RemoveQuestToGive(typeof(HarmonyLvl50EpicHibQuest));
		}
		...
		protected static void TalkToRevelin(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (Revelin.CanGiveQuest(typeof(HarmonyLvl50EpicHibQuest), player) <= 0)
				return;

			//We also check if the player is already doing the quest
			HarmonyLvl50EpicHibQuest quest = player.IsDoingQuest(typeof(HarmonyLvl50EpicHibQuest)) as HarmonyLvl50EpicHibQuest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "services":
							player.Out.SendQuestSubscribeCommand(Revelin, QuestMgr.GetIDForQuestType(typeof(HarmonyLvl50EpicHibQuest)), "Will you help Revelin [Path of Harmony Level 50 Epic]?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof(HarmonyLvl50EpicHibQuest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(HarmonyLvl50EpicHibQuest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Revelin.GiveQuest(typeof(HarmonyLvl50EpicHibQuest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(HarmonyLvl50EpicHibQuest)) == null)
				return;
