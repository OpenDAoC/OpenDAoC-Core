...
namespace DOL.Events
{
	...
	public class ItemEquippedArgs : EventArgs
	{
		...
		public ItemEquippedArgs(DbInventoryItems item, eInventorySlot previousSlotPosition)
		{
			m_item = item;
		...
		/// <param name="item">The equipped item</param>
		/// <param name="previousSlotPosition">The slot position item had before it was equipped</param>
		public ItemEquippedArgs(DbInventoryItems item, int previousSlotPosition)
		{
			m_item = item;
