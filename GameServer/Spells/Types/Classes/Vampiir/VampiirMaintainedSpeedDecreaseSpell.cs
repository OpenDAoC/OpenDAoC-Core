...
public class VampiirMaintainedSpeedDecreaseSpell : SpeedDecreaseSpell
{
    ...
    public VampiirMaintainedSpeedDecreaseSpell(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) { }
