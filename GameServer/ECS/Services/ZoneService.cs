...
public static class ZoneService
{
    ...
    public static void Tick()
    {
        ...
        Parallel.For(0, lastValidIndex + 1, i =>
        {
            ...
            EntityMgr.Remove(objectChangingSubZone);
...
public class ObjectChangingSubZone : IManagedEntity
{
    ...
    {
        if (EntityMgr.TryReuse(EEntityType.ObjectChangingSubZone, out ObjectChangingSubZone objectChangingSubZone))
        ...
        else
        {
            ...
            EntityMgr.Add(objectChangingSubZone);
        }
    }
