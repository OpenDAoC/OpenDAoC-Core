...
/// </summary>
public abstract class AbilityConstants
{
	// basics
	/// <summary>
	...
	public static EObjectType AbilityToWeapon( string abilityKeyName )
	{
		...
		{
			case AbilityConstants.Shield:
				type = EObjectType.Shield; break;
			case AbilityConstants.Weapon_Axes:
				type = EObjectType.Axe; break;
			case AbilityConstants.Weapon_Blades:
				type = EObjectType.Blades; break;
			case AbilityConstants.Weapon_Blunt:
				type = EObjectType.Blunt; break;
			case AbilityConstants.Weapon_CelticSpear:
				type = EObjectType.CelticSpear; break;
			case AbilityConstants.Weapon_CompositeBows:
				type = EObjectType.CompositeBow; break;
			case AbilityConstants.Weapon_Crossbow:
				type = EObjectType.Crossbow; break;
			case AbilityConstants.Weapon_Crushing:
				type = EObjectType.CrushingWeapon; break;
			case AbilityConstants.Weapon_FistWraps:
				type = EObjectType.FistWraps; break;
			case AbilityConstants.Weapon_Flexible:
				type = EObjectType.Flexible; break;
			case AbilityConstants.Weapon_Hammers:
				type = EObjectType.Hammer; break;
			case AbilityConstants.Weapon_HandToHand:
				type = EObjectType.HandToHand; break;
			case AbilityConstants.Weapon_Instruments:
				type = EObjectType.Instrument; break;
			case AbilityConstants.Weapon_LargeWeapons:
				type = EObjectType.LargeWeapons; break;
			case AbilityConstants.Weapon_LeftAxes:
				type = EObjectType.LeftAxe; break;
			case AbilityConstants.Weapon_Longbows:
				type = EObjectType.Longbow; break;
			case AbilityConstants.Weapon_MaulerStaff:
				type = EObjectType.MaulerStaff; break;
			case AbilityConstants.Weapon_Piercing:
				type = EObjectType.Piercing; break;
			case AbilityConstants.Weapon_Polearms:
				type = EObjectType.PolearmWeapon; break;
			case AbilityConstants.Weapon_RecurvedBows:
				type = EObjectType.RecurvedBow; break;
			case AbilityConstants.Weapon_Scythe:
				type = EObjectType.Scythe; break;
			case AbilityConstants.Weapon_Shortbows:
				type = EObjectType.Fired; break;
			case AbilityConstants.Weapon_Slashing:
				type = EObjectType.SlashingWeapon; break;
			case AbilityConstants.Weapon_Spears:
				type = EObjectType.Spear; break;
			case AbilityConstants.Weapon_Staves:
				type = EObjectType.Staff; break;
			case AbilityConstants.Weapon_Swords:
				type = EObjectType.Sword; break;
			case AbilityConstants.Weapon_Thrown:
				type = EObjectType.Thrown; break;
			case AbilityConstants.Weapon_Thrusting:
				type = EObjectType.ThrustWeapon; break;
			case AbilityConstants.Weapon_TwoHanded:
...
#region Spec Constants
/// <summary>
/// strong name constants for built in specs
/// </summary>
public abstract class SpecConstants
{
	/// <summary>
	/// Slash Weapon Spec
	/// </summary>
