                ...
                case "view":
                    {
                        ...
                        if (appeal != null)
                        {
                            ...
                            List<string> msg = new()
                            {
                                $"[Name]: {appeal.Name}, [Current]: {appeal.CurrentCharacterName}, [Status]: {appeal.Status}, [Priority]: {appeal.SeverityToName}, [Issue]: {appeal.Text}, [Time]: {appeal.Timestamp}.\n",
                            ...
                            client.Out.SendCustomTextWindow("Viewing " + appeal.CurrentCharacterName + "'s Appeal", msg);
                            return;
                        }
                ...
                case "listall":
                    {
                        ...
                        if (crit > 0)
                        {
                            ...
                            foreach (DbAppeal a in appeallist)
                            {
                                ...
                                {
                                    msg.Add($"[Name]: {a.Name}, [Current]: {a.CurrentCharacterName}, [Status]: {a.Status}, [Priority]: {a.SeverityToName} [Issue]: {a.Text}, [Time]: {a.Timestamp}.\n");
                                }
                            }
                        }
                        if (high > 0)
