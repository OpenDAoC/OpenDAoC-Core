					...
					case "summon":
						{
							...
							if (curBoat == null && boatFound != 1)
							{
								if (GameBoat.PlayerHasItem(client.Player, "scout_boat"))
								{
									...
									DbInventoryItems item = client.Player.Inventory.GetFirstItemByID("scout_boat", eInventorySlot.Min_Inv, eInventorySlot.Max_Inv);
								...
								{
									GameBoat playerBoat = new GameBoat();
									DbInventoryItems item = client.Player.Inventory.GetFirstItemByID("warship", eInventorySlot.Min_Inv, eInventorySlot.Max_Inv);
									playerBoat.BoatID = System.Guid.NewGuid().ToString();
								...
								{
									GameBoat playerBoat = new GameBoat();
									DbInventoryItems item = client.Player.Inventory.GetFirstItemByID("galleon", eInventorySlot.Min_Inv, eInventorySlot.Max_Inv);
									playerBoat.BoatID = System.Guid.NewGuid().ToString();
								...
								{
									GameBoat playerBoat = new GameBoat();
									DbInventoryItems item = client.Player.Inventory.GetFirstItemByID("skiff", eInventorySlot.Min_Inv, eInventorySlot.Max_Inv);
									playerBoat.BoatID = System.Guid.NewGuid().ToString();
								...
								{
									GameBoat playerBoat = new GameBoat();
									DbInventoryItems item = client.Player.Inventory.GetFirstItemByID("Viking_Longship", eInventorySlot.Min_Inv, eInventorySlot.Max_Inv);
									playerBoat.BoatID = System.Guid.NewGuid().ToString();
								...
								{
									GameBoat playerBoat = new GameBoat();
									DbInventoryItems item = client.Player.Inventory.GetFirstItemByID("ps_longship", eInventorySlot.Min_Inv, eInventorySlot.Max_Inv);
									playerBoat.BoatID = System.Guid.NewGuid().ToString();
								...
								{
									GameBoat playerBoat = new GameBoat();
									DbInventoryItems item = client.Player.Inventory.GetFirstItemByID("stygian_ship", eInventorySlot.Min_Inv, eInventorySlot.Max_Inv);
									playerBoat.BoatID = System.Guid.NewGuid().ToString();
								...
								{
									GameBoat playerBoat = new GameBoat();
									DbInventoryItems item = client.Player.Inventory.GetFirstItemByID("atlantean_ship", eInventorySlot.Min_Inv, eInventorySlot.Max_Inv);
									playerBoat.BoatID = System.Guid.NewGuid().ToString();
								...
								{
									GameBoat playerBoat = new GameBoat();
									DbInventoryItems item = client.Player.Inventory.GetFirstItemByID("British_Cog", eInventorySlot.Min_Inv, eInventorySlot.Max_Inv);
									playerBoat.BoatID = System.Guid.NewGuid().ToString();
