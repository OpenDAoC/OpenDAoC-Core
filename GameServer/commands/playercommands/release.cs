 ...
 namespace DOL.GS.Commands
{
	...
	public class ReleaseCommandHandler : AbstractCommandHandler, ICommandHandler
	{
		...
		{
			if (client.Player.CurrentRegion.IsRvR && !client.Player.CurrentRegion.IsDungeon || ServerProperties.Properties.EVENT_THIDRANKI || ServerProperties.Properties.EVENT_PVP)
			{
