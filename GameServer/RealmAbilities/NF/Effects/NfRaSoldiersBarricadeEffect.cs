...
public class NfRaSoldiersBarricadeEffect : StaticEffect, IGameEffect
{
	...
	/// </summary>
	public NfRaSoldiersBarricadeEffect()
	{
	...
	private static void PlayerLeftWorld(CoreEvent e, object sender, EventArgs args)
	{
		...
		NfRaSoldiersBarricadeEffect SBEffect = player.EffectList.GetOfType<NfRaSoldiersBarricadeEffect>();
		if (SBEffect != null)
		{
