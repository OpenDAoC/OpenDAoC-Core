...
public class NfRaShieldOfImmunityEffect : TimedEffect
{
	...
	public NfRaShieldOfImmunityEffect()
		: base(20000)
	{
	}
	...
	private void OnAttack(CoreEvent e, object sender, EventArgs arguments)
	{
		...
		if (ad.Damage < 1)
			return;
		if (ad.IsMeleeAttack || ad.AttackType == EAttackType.Ranged || (ad.AttackType == EAttackType.Spell && attackedByEnemy.AttackData.SpellHandler.Spell.SpellType == ESpellType.Archery))
		{
