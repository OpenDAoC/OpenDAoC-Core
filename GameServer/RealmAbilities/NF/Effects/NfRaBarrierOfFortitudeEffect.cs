...
{
	public class NfRaBarrierOfFortitudeEffect : StaticEffect, IGameEffect
	{
		...
		/// </summary>
		public NfRaBarrierOfFortitudeEffect()
		{
		...
		public void Start(GamePlayer player, int duration, int value)
		{
			...
			if (player.TempProperties.GetProperty(RealmAbilities.NfRaBarrierOfFortitudeAbility.BofBaSb, false))
				return;
			...
			player.TempProperties.SetProperty(RealmAbilities.NfRaBarrierOfFortitudeAbility.BofBaSb, true);
		}
		...
		private static void PlayerLeftWorld(CoreEvent e, object sender, EventArgs args)
		{
			...
			NfRaBarrierOfFortitudeEffect BoFEffect = player.EffectList.GetOfType<NfRaBarrierOfFortitudeEffect>();
			if (BoFEffect != null)
			{
		...
		public override void Cancel(bool playerCancel)
		{
			...
			m_player.TempProperties.RemoveProperty(RealmAbilities.NfRaBarrierOfFortitudeAbility.BofBaSb);
		}
