...
public class NfRaStaticTempestAbility : TimedRealmAbility
{
    public NfRaStaticTempestAbility(DbAbility dba, int level) : base(dba, level) { }
    ...
    public override void Execute(GameLiving living)
	{
        ...
        */
        ...
        StaticTempestBase st = new StaticTempestBase(m_stunDuration);
