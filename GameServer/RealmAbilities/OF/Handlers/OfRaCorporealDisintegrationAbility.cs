...
public class OfRaCorporealDisintegrationAbility : TimedRealmAbility, ISpellCastingAbilityHandler
{
    public OfRaCorporealDisintegrationAbility(DbAbility dba, int level) : base(dba, level) { }
