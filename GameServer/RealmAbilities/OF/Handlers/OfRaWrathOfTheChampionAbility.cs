...
public class OfRaWrathOfTheChampionAbility : TimedRealmAbility, ISpellCastingAbilityHandler
{
    public OfRaWrathOfTheChampionAbility(DbAbility dba, int level) : base(dba, level) { }
