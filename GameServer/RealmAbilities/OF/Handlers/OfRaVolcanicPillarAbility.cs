...
public class OfRaVolcanicPillarAbility : TimedRealmAbility, ISpellCastingAbilityHandler
{
    public OfRaVolcanicPillarAbility(DbAbility dba, int level) : base(dba, level) { }
