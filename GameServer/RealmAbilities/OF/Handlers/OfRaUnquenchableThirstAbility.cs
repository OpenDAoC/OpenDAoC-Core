...
public class OfRaUnquenchableThirstAbility : TimedRealmAbility, ISpellCastingAbilityHandler
{
    public OfRaUnquenchableThirstAbility(DbAbility dba, int level) : base(dba, level) { }
