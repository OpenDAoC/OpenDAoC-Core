...
namespace Core.GS.RealmAbilities
{
    ...
    {
		public OfRaStrikingTheSoulAbility(DbAbility dba, int level) : base(dba, level) { }
		...
		public override void Execute(GameLiving living)
		{
			...
			new OfRaStrikeTheSoulEcsEffect(new EcsGameEffectInitParams(player, m_duration, m_value));
