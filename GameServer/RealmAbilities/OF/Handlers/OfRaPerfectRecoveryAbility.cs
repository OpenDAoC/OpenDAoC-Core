...
public class OfRaPerfectRecoveryAbility : TimedRealmAbility, ISpellCastingAbilityHandler
{
    public OfRaPerfectRecoveryAbility(DbAbility dba, int level) : base(dba, level) { }
