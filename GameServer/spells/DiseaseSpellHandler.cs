...
namespace DOL.GS.Spells
{
    ...
    public class DiseaseSpellHandler : SpellHandler
    {
        ...
        public override string ShortDescription => $"Inflicts a wasting disease on the target that slows target by 15%, reduces its strength by 7.5% and inhibits healing by 50%{GetFrequencyAndDurationSuffix()}.";
