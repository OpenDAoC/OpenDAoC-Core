...
namespace DOL.GS.Spells
{
	...
	public class GatewayPersonalBind : SpellHandler
	{
		...
		public override bool CheckBeginCast(GameLiving selectedTarget)
		{
			...
			if ((player.CurrentZone.IsRvR || player.CurrentRegion.IsInstance || player.CurrentRegion.IsFrontier) && GameServer.Instance.Configuration.ServerType != eGameServerType.GST_PvE)
			{
