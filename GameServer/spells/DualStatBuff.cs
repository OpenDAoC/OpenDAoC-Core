...
namespace DOL.GS.Spells
{
    ...
    {
        public override string ShortDescription => $"Increases {TargetPronoun} {PropertyToString(Property1)} and {PropertyToString(Property2)} by {Spell.Value}{GetFrequencyAndDurationSuffix()}.";
