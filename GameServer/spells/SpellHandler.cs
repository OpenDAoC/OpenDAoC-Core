...
// 			}
		...
		public virtual void ApplyEffectOnTarget(GameLiving target)
		{
			...
			if (!HasPositiveEffect)
			{
				...
				if (ad.Damage == 0 && ad.SpellHandler.Spell.SpellType != eSpellType.DamageOverTime && ad.SpellHandler.Spell.SpellType != eSpellType.Prescience && ad.SpellHandler.Spell.SpellType != eSpellType.SpeedWarp)
