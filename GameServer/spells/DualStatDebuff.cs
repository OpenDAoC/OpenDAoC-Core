namespace DOL.GS.Spells
{
    ...
    {
        public override string ShortDescription => $"Decreases the target's {PropertyToString(Property1)} and {PropertyToString(Property2)} by {Spell.Value}{GetFrequencyAndDurationSuffix()}.";
