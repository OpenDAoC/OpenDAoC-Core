...
namespace DOL.GS.Spells
{
    ...
    public class HealFlask : SpellHandler
    {
        ...
        {
            new IncomingHealBoostECSEffect(new ECSGameEffectInitParams(target, 600000, 10, this));
        }
    ...
    public class DeadFlask : SpellHandler
    {
        ...
        public override void ApplyEffectOnTarget(GameLiving target)
        {
            new CheatDeathECSEffect(new ECSGameEffectInitParams(target, 900000, 10, this));
        }
