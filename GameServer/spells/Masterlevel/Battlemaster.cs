        ...
        protected override void EventHandler(DOLEvent e, object sender, EventArgs arguments)
        {
            ...
            if (ad.IsMeleeAttack)
            {
                if (sender is GamePlayer)
                {
                    ...
                    DbInventoryItems leftWeapon = player.Inventory.GetItem(eInventorySlot.LeftHandWeapon);
            ...
            if (showEffectAnimation && ad.Target != null)
            {
                ...
                switch (ad.AttackResult)
                {
                    ...
                    case eAttackResult.Blocked:
                        ...
                        {
                            DbInventoryItems lefthand = ad.Target.Inventory.GetItem(eInventorySlot.LeftHandWeapon);
