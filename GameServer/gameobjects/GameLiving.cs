...
namespace DOL.GS
{
	...
	public abstract class GameLiving : GameObject
	{
        ...
        public virtual int AttackSpeed(DbInventoryItems mainWeapon, DbInventoryItems leftWeapon = null)
        {
        ...
        /// <returns></returns>
        public virtual int GetWeaponStat(DbInventoryItems weapon)
		{
		...
		/// </summary>
		public virtual double GetWeaponSkill(DbInventoryItems weapon)
		{
			// Needs to be overridden.
			return 0;
		}

		private (DbInventoryItems item, long time) m_cachedActiveWeapon;

        /// <summary>
        /// Returns the currently active weapon, null=natural
        /// </summary>
        public virtual DbInventoryItems ActiveWeapon
        {
            get
            {
		...
		/// </summary>
		public virtual int WeaponSpecLevel(DbInventoryItems weapon)
		{
		...
		public virtual double WeaponDamage(DbInventoryItems weapon)
		{
			return 0;
		}
		...
		/// <param name="weapon"></param>
		/// <returns></returns>
		public virtual bool AllowWeaponMagicalEffect(AttackData ad, DbInventoryItems weapon, Spell weaponSpell)
		{
		...
		/// <param name="ad"></param>
		/// <param name="weapon"></param>
		public virtual void CheckWeaponMagicalEffect(AttackData ad, DbInventoryItems weapon)
		{
		...
		/// </summary>
		protected virtual void StartWeaponMagicalEffect(DbInventoryItems weapon, AttackData ad, SpellLine spellLine, int spellID, bool ignoreLevel)
		{
			if (weapon == null)
				return;
		...
		public double GetAttackerDefensePenetration(GameLiving living, DbInventoryItems weapon)
		{
