...
namespace DOL.GS
{
	...
	public class Enchanter : GameNPC
	{
		...
		protected void EnchanterDialogResponse(GamePlayer player, byte response)
		{
			...
			DbInventoryItems item = (DbInventoryItems) itemWeak.Target;
            ...
            player.Out.SendInventoryItemsUpdate(new DbInventoryItems[] { item });
		...
		public long CalculEnchantPrice(DbInventoryItems item)
		{
			return (item.Price/5);
		}
	}
