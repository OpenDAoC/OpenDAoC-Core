...
namespace DOL.GS
{
	...
	public class StatsCustomiser : GameNPC
	{
		...
		public override bool Interact(GamePlayer player)
		{
			...
			var alreadyReset = DOLDB<DbCoreCharactersXCustomParam>.SelectObject(DB.Column("DOLCharactersObjectId")
		...
		public override bool WhisperReceive(GameLiving source, string text)
		{
			...
			if (alreadyReset == null && text == "stats respec")
			{
				...
				DbCoreCharactersXCustomParam statsReset = new DbCoreCharactersXCustomParam();
