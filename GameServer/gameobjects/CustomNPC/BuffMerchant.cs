		...
		public static Spell MerchBaseAFBuff
		{
			get
			{
				if (m_baseaf == null)
				{
					...
					spell.SpellID = 88001;
					spell.Target = "Realm";
					spell.Type = (byte)eSpellType.ArmorFactorBuff;
					spell.EffectGroup = 1;
		...
		public static Spell MerchStrBuff
		{
			get
			{
				if (m_basestr == null)
				{
					...
					spell.SpellID = 88002;
					spell.Target = "Realm";
					spell.Type = (byte)eSpellType.StrengthBuff;
					spell.EffectGroup = 4;
		...
		public static Spell MerchConBuff
		{
			get
			{
				if (m_basecon == null)
				{
					...
					spell.SpellID = 88003;
					spell.Target = "Realm";
					spell.Type = (byte)eSpellType.ConstitutionBuff;
		...
		public static Spell MerchDexBuff
		{
			get
			{
				if (m_basedex == null)
				{
					...
					spell.SpellID = 88004;
					spell.Target = "Realm";
					spell.Type = (byte)eSpellType.DexterityBuff;
		...
		public static Spell MerchStrConBuff
		{
			get
			{
				if (m_strcon == null)
				{
					...
					spell.SpellID = 88005;
					spell.Target = "Realm";
					spell.Type = (byte)eSpellType.StrengthConstitutionBuff;
		...
		public static Spell MerchDexQuiBuff
		{
			get
			{
				if (m_dexqui == null)
				{
					...
					spell.SpellID = 88006;
					spell.Target = "Realm";
					spell.Type = (byte)eSpellType.DexterityQuicknessBuff;
		...
		public static Spell MerchAcuityBuff
		{
			get
			{
				if (m_acuity == null)
				{
					...
					spell.SpellID = 88007;
					spell.Target = "Realm";
					spell.Type = (byte)eSpellType.AcuityBuff;
		...
		public static Spell MerchHasteBuff
		{
			get
			{
				if (m_haste == null)
				{
					...
					spell.SpellID = 88010;
					spell.Target = "Realm";
					spell.Type = (byte)eSpellType.CombatSpeedBuff;
