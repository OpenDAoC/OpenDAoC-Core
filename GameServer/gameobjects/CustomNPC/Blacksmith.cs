...
namespace DOL.GS
{
    ...
    public class Blacksmith : GameNPC
    {
        ...
        public override IList GetExamineMessages(GamePlayer player)
        {
            ...
            list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "Scripts.Blacksmith.YouTarget",
                GetName(0, false, player.Client.Account.Language, this)));
            list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "Scripts.Blacksmith.YouExamine",
                GetName(0, false, player.Client.Account.Language, this),
                GetPronoun(0, true, player.Client.Account.Language), GetAggroLevelString(player, false)));
            list.Add(LanguageMgr.GetTranslation(player.Client.Account.Language, "Scripts.Blacksmith.GiveObject",
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            SayTo(player, eChatLoc.CL_PopupWindow,
                LanguageMgr.GetTranslation(player.Client.Account.Language, "Scripts.Blacksmith.Say"));
            return true;
        }
