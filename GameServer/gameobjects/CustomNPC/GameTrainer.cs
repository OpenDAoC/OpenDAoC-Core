...
namespace DOL.GS
{
	...
	public class GameTrainer : GameNPC
	{
		...
		protected virtual void CheckAbilityToUseItem(GamePlayer player)
		{
			...
			{
				foreach (DbInventoryItems item in player.Inventory.EquippedItems)
				{
		...
		public bool PromotePlayer(GamePlayer player, int classid, string messageToPlayer, DbInventoryItems[] gifts)
		{
			if (player == null)
				return false;
