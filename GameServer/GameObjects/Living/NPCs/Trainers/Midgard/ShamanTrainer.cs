...
public class ShamanTrainer : GameTrainer
{
	...
	{
		get { return EPlayerClass.Shaman; }
	}
	...
	public override bool WhisperReceive(GameLiving source, string text)
	{
		...
		switch (text) {
			case "join the House of Ymir":
				...
				if (CanPromotePlayer(player)) {
					PromotePlayer(player, (int)EPlayerClass.Shaman, "Welcome young Shaman! May your time in Midgard army be rewarding!", null);	// TODO: gifts
				}
				break;
		}
		return true;
