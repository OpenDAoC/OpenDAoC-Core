...
namespace DOL.GS.Effects
{
	...
	public class ShieldOfImmunityEffect : TimedEffect
	{
		...
		private void OnAttack(DOLEvent e, object sender, EventArgs arguments)
		{
			...
			if (ad.Damage < 1)
				return;
			if (ad.IsMeleeAttack || ad.AttackType == AttackData.eAttackType.Ranged || (ad.AttackType == AttackData.eAttackType.Spell && attackedByEnemy.AttackData.SpellHandler.Spell.SpellType == (byte)eSpellType.Archery))
			{
