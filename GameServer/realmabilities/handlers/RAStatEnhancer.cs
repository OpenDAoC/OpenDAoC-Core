...
namespace DOL.GS.RealmAbilities
{
	...
	public class RAStatEnhancer : L5RealmAbility
	{
		...
		public virtual void SendUpdates(GameLiving target)
		{
			...
			target.effectListComponent.RequestPlayerUpdate(EffectHelper.PlayerUpdate.Encumbrance | EffectHelper.PlayerUpdate.WeaponArmor | EffectHelper.PlayerUpdate.Stats);
		}
