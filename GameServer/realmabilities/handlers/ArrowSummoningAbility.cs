...
namespace DOL.GS.RealmAbilities
{
    public class ArrowSummoningAbility : TimedRealmAbility
	{
        ...
        public ArrowSummoningAbility(DbAbilities dba, int level) : base(dba, level) { }
        public override void Execute(GameLiving living)
		{
            if (CheckPreconditions(living, DEAD | SITTING | MEZZED | STUNNED)) return;
            GamePlayer player = living as GamePlayer;
            DbItemTemplates arrow_summoning_1 = GameServer.Database.FindObjectByKey<DbItemTemplates>("arrow_summoning1");
            DbItemTemplates arrow_summoning_2 = GameServer.Database.FindObjectByKey<DbItemTemplates>("arrow_summoning2");
            DbItemTemplates arrow_summoning_3 = GameServer.Database.FindObjectByKey<DbItemTemplates>("arrow_summoning3");
		...
		public void PlayerQuit(DOLEvent e, object sender, EventArgs arguments)
		{
			...
			{
                DbInventoryItems item = player.Inventory.GetFirstItemByID("arrow_summoning1", eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack);
				while (item != null)
				{
		...
		public static void OnScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			{
				arrow_summoning1 = new DbItemTemplates();
			...
			DbItemTemplates arrow_summoning2 = GameServer.Database.FindObjectByKey<DbItemTemplates>("arrow_summoning2");
			if (arrow_summoning2 == null)
			{
				arrow_summoning2 = new DbItemTemplates();
			...
			DbItemTemplates arrow_summoning3 = GameServer.Database.FindObjectByKey<DbItemTemplates>("arrow_summoning3");
			if (arrow_summoning3 == null)
			{
				arrow_summoning3 = new DbItemTemplates();
