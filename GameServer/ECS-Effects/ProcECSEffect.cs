...
namespace DOL.GS
{
    public class ProcECSGameEffect : ECSGameEffect
    {
        ...
        public override void OnStartEffect()
        {
            ...
            (SpellHandler as OffensiveProcSpellHandler).MessageToLiving(Owner, SpellHandler.Spell.Message1, chatType);
        ...
        {
            (SpellHandler as OffensiveProcSpellHandler).MessageToLiving(Owner, SpellHandler.Spell.Message3, eChatType.CT_SpellExpires);
