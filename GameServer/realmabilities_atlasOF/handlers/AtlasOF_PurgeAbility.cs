...
namespace DOL.GS.RealmAbilities
{
    ...
    {
        public AtlasOF_PurgeAbility(DbAbilities dba, int level) : base(dba, level) { }
    ...
    {
        public AtlasOF_PurgeAbilityReduced(DbAbilities dba, int level) : base(dba, level) { }
    ...
    {
        public AtlasOF_GroupPurge(DbAbilities dba, int level) : base(dba, level) { }
