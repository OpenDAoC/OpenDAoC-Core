...
namespace DOL.GS.RealmAbilities
{
	...
	{
		public AtlasOF_DeterminationAbility(DbAbilities dba, int level) : base(dba, level) { }
	...
	{
		public AtlasOF_DeterminationHybridAbility(DbAbilities dba, int level) : base(dba, level) { }
