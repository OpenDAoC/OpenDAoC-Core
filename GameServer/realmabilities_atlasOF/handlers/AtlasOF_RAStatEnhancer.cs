...
namespace DOL.GS.RealmAbilities
{
	...
	/// 
	/// </summary>
	public class AtlasOF_RAStatEnhancer : L5RealmAbility
	{
		...
		public AtlasOF_RAStatEnhancer(DBAbility dba, int level, eProperty property)
			: base(dba, level)
		{
			m_property = property;
		}
	...
	public class AtlasOF_RAStrengthEnhancer : RAStatEnhancer
	{
		public AtlasOF_RAStrengthEnhancer(DBAbility dba, int level) : base(dba, level, eProperty.Strength) { }
	}

	public class AtlasOF_RAConstitutionEnhancer : RAStatEnhancer
	{
		public AtlasOF_RAConstitutionEnhancer(DBAbility dba, int level) : base(dba, level, eProperty.Constitution) { }
	}

	public class AtlasOF_RAQuicknessEnhancer : RAStatEnhancer
	{
		public AtlasOF_RAQuicknessEnhancer(DBAbility dba, int level) : base(dba, level, eProperty.Quickness) { }
	}

	public class AtlasOF_RADexterityEnhancer : RAStatEnhancer
	{
		public AtlasOF_RADexterityEnhancer(DBAbility dba, int level) : base(dba, level, eProperty.Dexterity) { }
	}

	public class AtlasOF_RAAcuityEnhancer : RAStatEnhancer
	{
		public AtlasOF_RAAcuityEnhancer(DBAbility dba, int level) : base(dba, level, eProperty.Acuity) { }
	}

	public class AtlasOF_RAMaxManaEnhancer : RAStatEnhancer
	{
		public AtlasOF_RAMaxManaEnhancer(DBAbility dba, int level) : base(dba, level, eProperty.MaxMana) { }
	}

	public class AtlasOF_RAMaxHealthEnhancer : RAStatEnhancer
	{
		public AtlasOF_RAMaxHealthEnhancer(DBAbility dba, int level) : base(dba, level, eProperty.MaxHealth) { }
