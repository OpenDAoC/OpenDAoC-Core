...
namespace DOL.GS.RealmAbilities
{
	...
	{
		public AtlasOF_RAStrengthEnhancer(DbAbilities dba, int level) : base(dba, level) { }
	...
	{
		public AtlasOF_RAConstitutionEnhancer(DbAbilities dba, int level) : base(dba, level) { }
        public override int CostForUpgrade(int level) { return AtlasRAHelpers.GetCommonUpgradeCostFor5LevelsRA(level); }
        public override int GetAmountForLevel(int level) { return AtlasRAHelpers.GetStatEnhancerAmountForLevel(level); }
    }
	...
	{
		public AtlasOF_RAQuicknessEnhancer(DbAbilities dba, int level) : base(dba, level) { }
        public override int CostForUpgrade(int level) { return AtlasRAHelpers.GetCommonUpgradeCostFor5LevelsRA(level); }
        public override int GetAmountForLevel(int level) { return AtlasRAHelpers.GetStatEnhancerAmountForLevel(level); }
    }
	...
	{
		public AtlasOF_RADexterityEnhancer(DbAbilities dba, int level) : base(dba, level) { }
        public override int CostForUpgrade(int level) { return AtlasRAHelpers.GetCommonUpgradeCostFor5LevelsRA(level); }
        public override int GetAmountForLevel(int level) { return AtlasRAHelpers.GetStatEnhancerAmountForLevel(level); }
    }
	...
	{
		public AtlasOF_RAAcuityEnhancer(DbAbilities dba, int level) : base(dba, level) { }
        public override int CostForUpgrade(int level) { return AtlasRAHelpers.GetCommonUpgradeCostFor5LevelsRA(level); }
        public override int GetAmountForLevel(int level) { return AtlasRAHelpers.GetStatEnhancerAmountForLevel(level); }
    }
	...
	{
		public AtlasOF_RAMaxManaEnhancer(DbAbilities dba, int level) : base(dba, level) { }
        public override int CostForUpgrade(int level) { return AtlasRAHelpers.GetCommonUpgradeCostFor5LevelsRA(level); }
	...
	{
		public AtlasOF_RAMaxHealthEnhancer(DbAbilities dba, int level) : base(dba, level) { }
        public override int CostForUpgrade(int level) { return AtlasRAHelpers.GetCommonUpgradeCostFor5LevelsRA(level); }
        public override int GetAmountForLevel(int level) { return AtlasRAHelpers.GetPropertyEnhancer3AmountForLevel(level); }
	...
	{
		public AtlasOF_RAEndRegenEnhancer(DbAbilities dba, int level) : base(dba, level) { }
