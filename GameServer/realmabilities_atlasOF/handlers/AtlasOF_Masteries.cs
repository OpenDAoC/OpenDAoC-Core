...
namespace DOL.GS.RealmAbilities
{
	...
	{
		public AtlasOF_MasteryOfPain(DbAbilities dba, int level) : base(dba, level) { }
	...
	{
        public AtlasOF_MasteryOfParrying(DbAbilities dba, int level) : base(dba, level) { }
        public override bool CheckRequirement(GamePlayer player) { return AtlasRAHelpers.GetAugDexLevel(player) >= 2; }
    ...
    {
        public AtlasOF_MasteryOfBlocking(DbAbilities dba, int level) : base(dba, level) { }
        public override bool CheckRequirement(GamePlayer player) { return AtlasRAHelpers.GetAugDexLevel(player) >= 2; }
        public override int GetAmountForLevel(int level) { return AtlasRAHelpers.GetPropertyEnhancer3AmountForLevel(level); }
        public override int CostForUpgrade(int level) { return AtlasRAHelpers.GetCommonUpgradeCostFor5LevelsRA(level); }
    }
    ...
    {
        public AtlasOF_MasteryOfHealing(DbAbilities dba, int level) : base(dba, level) { }
    ...
    {
        public AtlasOF_MasteryOfArms(DbAbilities dba, int level) : base(dba, level, eProperty.MeleeSpeed) { }
    ...
    {
        public AtlasOF_MasteryOfArchery(DbAbilities dba, int level) : base(dba, level, eProperty.ArcherySpeed) { }
        protected override string ValueUnit { get { return "%"; } }
    ...
    {
        public AtlasOF_MasteryOfTheArt(DbAbilities dba, int level) : base(dba, level, eProperty.CastingSpeed) { }
        protected override string ValueUnit { get { return "%"; } }
    ...
    {
        public AtlasOF_MasteryOfMagery(DbAbilities dba, int level) : base(dba, level, eProperty.SpellDamage) { }
        protected override string ValueUnit { get { return "%"; } }
        public override bool CheckRequirement(GamePlayer player) { return AtlasRAHelpers.GetAugAcuityLevel(player) >= 2; }
        public override int GetAmountForLevel(int level) { return AtlasRAHelpers.GetPropertyEnhancer3AmountForLevel(level); }
        public override int CostForUpgrade(int level) { return AtlasRAHelpers.GetCommonUpgradeCostFor5LevelsRA(level); }
    ...
    {
        public AtlasOF_MasteryOfTheArcane(DbAbilities dba, int level) : base(dba, level, eProperty.BuffEffectiveness) { }
        protected override string ValueUnit { get { return "%"; } }
        public override bool CheckRequirement(GamePlayer player) { return AtlasRAHelpers.GetAugAcuityLevel(player) >= 2; }
        public override int GetAmountForLevel(int level) { return AtlasRAHelpers.GetPropertyEnhancer3AmountForLevel(level); }
        public override int CostForUpgrade(int level) { return AtlasRAHelpers.GetCommonUpgradeCostFor5LevelsRA(level); }
    ...
    {
        public AtlasOF_MasteryOfWater(DbAbilities dba, int level) : base(dba, level, eProperty.WaterSpeed) { }
        protected override string ValueUnit { get { return "%"; } }
        public override int GetAmountForLevel(int level) { return AtlasRAHelpers.GetPropertyEnhancer3AmountForLevel(level); }
        public override int CostForUpgrade(int level) { return AtlasRAHelpers.GetCommonUpgradeCostFor5LevelsRA(level); }
    }
    ...
    {
        public AtlasOF_Dodger(DbAbilities dba, int level) : base(dba, level, eProperty.EvadeChance) { }
        protected override string ValueUnit { get { return "%"; } }
	...
	{
        public AtlasOF_MasteryOfStealth(DbAbilities dba, int level) : base(dba, level) { }
        protected override string ValueUnit { get { return "%"; } }
        public override bool CheckRequirement(GamePlayer player) { return AtlasRAHelpers.GetAugQuiLevel(player) >= 2; }
        public override int GetAmountForLevel(int level) { return AtlasRAHelpers.GetPropertyEnhancer5AmountForLevel(level); }
    ...
    {
        public AtlasOF_DualistsReflexes(DbAbilities dba, int level) : base(dba, level, eProperty.OffhandDamageAndChance) { }
        protected override string ValueUnit { get { return "%"; } }
        public override bool CheckRequirement(GamePlayer player) { return AtlasRAHelpers.GetAugDexLevel(player) >= 2; }
        public override int GetAmountForLevel(int level) { return AtlasRAHelpers.GetPropertyEnhancer3AmountForLevel(level); }
        public override int CostForUpgrade(int level) { return AtlasRAHelpers.GetCommonUpgradeCostFor5LevelsRA(level); }
    ...
    {
        public AtlasOF_ArrowSalvaging(DbAbilities dba, int level) : base(dba, level, eProperty.ArrowRecovery) { }
        protected override string ValueUnit { get { return "%"; } }
