...
{
	/// <summary>
	/// Effect handler for Soldier's Barricade
	/// </summary>
	public class AtlasOF_SoldiersBarricadeEffect : StaticEffect, IGameEffect
	{
		private const String m_delveString = "Grants the group a large Armor Factor bonus.";
		...
		/// <summary>
		/// Default constructor for Soldier's Barricade Effect
		/// </summary>
		public AtlasOF_SoldiersBarricadeEffect()
		{
		...
		public void Start(GamePlayer player, int duration, int value)
		{
			...
			if (player.TempProperties.getProperty(RealmAbilities.SoldiersBarricadeAbility.BofBaSb, false))
				return;
			...
			m_player.BuffBonusCategory4[(int)eProperty.ArmorFactor] += m_value;
            m_player.Out.SendUpdateWeaponAndArmorStats();
            m_player.EffectList.Add(this);
			player.TempProperties.setProperty(RealmAbilities.SoldiersBarricadeAbility.BofBaSb, true);
		}
		...
		private static void PlayerLeftWorld(DOLEvent e, object sender, EventArgs args)
		{
			...
			AtlasOF_SoldiersBarricadeEffect SBEffect = player.EffectList.GetOfType<AtlasOF_SoldiersBarricadeEffect>();
			if (SBEffect != null)
			{
		...
		public override void Cancel(bool playerCancel)
		{
			...
			m_player.TempProperties.removeProperty(RealmAbilities.SoldiersBarricadeAbility.BofBaSb);
		}
