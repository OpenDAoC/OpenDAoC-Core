...
namespace DOL.GS
{
	...
	public class GameClient : BaseClient, ICustomParamsValuable, IManagedEntity
	{
		...
		public void LoadPlayer(DbCoreCharacters dolChar)
		{
		...
		public void LoadPlayer(int accountindex, string playerClass)
		{
			...
			DbCoreCharacters dolChar = m_account.Characters[accountindex];
		...
		public void LoadPlayer(DbCoreCharacters dolChar, string playerClass)
		{
			m_activeCharIndex = 0;
