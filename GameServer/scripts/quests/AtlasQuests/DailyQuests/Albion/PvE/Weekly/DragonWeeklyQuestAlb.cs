...
namespace DOL.GS.DailyQuest.Albion
{
	public class DragonWeeklyQuestAlb : Quests.WeeklyQuest
	{
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			Cola.AddQuestToGive(typeof (DragonWeeklyQuestAlb));
		...
		public static void ScriptUnloaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			Cola.RemoveQuestToGive(typeof (DragonWeeklyQuestAlb));
		}
		...
		protected static void TalkToCola(DOLEvent e, object sender, EventArgs args)
		{
			...
			if(Cola.CanGiveQuest(typeof (DragonWeeklyQuestAlb), player)  <= 0)
				return;
			...
			if (e == GameObjectEvent.Interact)
			{
				if (quest != null)
				{
					...
					{
						case 1:
							Cola.SayTo(player, player.Name + ", please travel to Dartmoor and kill the dragon for Albion!");
							break;
						case 2:
							Cola.SayTo(player, "Hello " + player.Name + ", did you [slay the dragon] and return for your reward?");
							break;
					}
				}
				else
				{
					Cola.SayTo(player, "Hello "+ player.Name +", I am Cola. I bring sad news today. " + DRAGON_NAME + " razed a small settlement in Dartmoor last night. \n" +
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "kill the dragon":
							player.Out.SendQuestSubscribeCommand(Cola, QuestMgr.GetIDForQuestType(typeof(DragonWeeklyQuestAlb)), "Will you help Cola with "+questTitle+"?");
							break;
					}
				}
				else
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Cola.GiveQuest(typeof (DragonWeeklyQuestAlb), player, 1))
					return;

				Cola.SayTo(player, "Please, find the dragon in Dartmoor and defend our realm.");
