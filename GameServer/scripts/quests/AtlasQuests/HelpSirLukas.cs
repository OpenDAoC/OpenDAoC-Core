				...
				else
				{
					switch (wArgs.Text)
					{
						case "Vetusta Abbey":
							...
							SirLukas.SayTo(player, "Thank you " + player.Name + ", here is the speech. Go to the North Gates of Camelot. " +
                                "You will find Vetusta Abbey near the gates. I will meet you there... I need some time to collect my thoughts.");
							if (quest.Step == 3)
							{
								quest.Step = 4;
							}
