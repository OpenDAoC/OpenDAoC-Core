...
namespace DOL.GS.Commands
{
    ...
    public class SetSalvageCommandHandler : AbstractCommandHandler, ICommandHandler
    {
        ...
        public void OnCommand(GameClient client, string[] args)
        {
            ...
            DbInventoryItems item = client.Player.Inventory.GetItem((eInventorySlot)slot);
            ...
            if (idnb == string.Empty && (item.AllowAdd == false || item.Id_nb == DbInventoryItems.BLANK_ITEM))
            {
            ...
            client.Out.SendInventoryItemsUpdate(new DbInventoryItems[] { item });
