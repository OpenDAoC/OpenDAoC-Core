...
namespace DOL.GS
{
    public class OFGreenKnight : GameEpicBoss
    {
        ...
        public override bool AddToWorld()
        {
            ...
            OFGreenKnightBrain.atpoint1 = false;
            OFGreenKnightBrain.walk2 = false;
            OFGreenKnightBrain.atpoint2 = false;
            OFGreenKnightBrain.walk3 = false;
            OFGreenKnightBrain.atpoint3 = false;
            OFGreenKnightBrain.walk4 = false;
            OFGreenKnightBrain.atpoint4 = false;
...
namespace DOL.AI.Brain
{
    public class OFGreenKnightBrain : StandardMobBrain
    {
        ...
        public static bool atpoint1 = false;
        public static bool walk2 = false;
        public static bool atpoint2 = false;
        public static bool walk3 = false;
        public static bool atpoint3 = false;
        public static bool walk4 = false;
        public static bool atpoint4 = false;
        ...
        public int GkTeleport(RegionTimer timer)
        {
            if (Body.IsAlive)
            {
                ...
                point4.Y = 418052;
                point4.Z = 4942;
                if (!PortPoints.Contains(string1) && !PortPoints.Contains(string2) && !PortPoints.Contains(string3) &&
                    !PortPoints.Contains(string4))
                {
                    if (atpoint1 == false)
                    {
