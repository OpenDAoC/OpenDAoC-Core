		...
		public override void EnemyKilled(GameLiving enemy)
        {
			...
			if (enemy is GamePlayer)
			{
				if (player != null)
				{
					...
					{
						DbInventoryItems torso = player.Inventory.GetItem(eInventorySlot.TorsoArmor);
						if(torso != null)
					...
					{
						DbInventoryItems arms = player.Inventory.GetItem(eInventorySlot.ArmsArmor);
						if(arms != null)
					...
					{
						DbInventoryItems legs = player.Inventory.GetItem(eInventorySlot.LegsArmor);
						if(legs != null)
					...
					{
						DbInventoryItems head = player.Inventory.GetItem(eInventorySlot.HeadArmor);
						if(head != null)
					...
					{
						DbInventoryItems hands = player.Inventory.GetItem(eInventorySlot.HandsArmor);
						if(hands != null)
					...
					{
						DbInventoryItems feet = player.Inventory.GetItem(eInventorySlot.FeetArmor);
						if(feet != null)
					...
					{
						DbInventoryItems cloak = player.Inventory.GetItem(eInventorySlot.Cloak);
						if(cloak != null)
					...
					{
						DbInventoryItems righthand = player.Inventory.GetItem(eInventorySlot.RightHandWeapon);
						DbInventoryItems lefthand = player.Inventory.GetItem(eInventorySlot.LeftHandWeapon);
                    ...
                    {
						DbInventoryItems twohand = player.Inventory.GetItem(eInventorySlot.TwoHandWeapon);
						DbInventoryItems righthand = player.Inventory.GetItem(eInventorySlot.RightHandWeapon);
						if (twohand != null)
						{
					...
					{
						DbInventoryItems distance = player.Inventory.GetItem(eInventorySlot.DistanceWeapon);
						if(distance != null)
                    ...
                    DbInventoryItems mob_twohand = template.GetItem(eInventorySlot.TwoHandWeapon);
					DbInventoryItems mob_righthand = template.GetItem(eInventorySlot.RightHandWeapon);
					DbInventoryItems mob_lefthand = template.GetItem(eInventorySlot.LeftHandWeapon);
					DbInventoryItems mob_distance = template.GetItem(eInventorySlot.LeftHandWeapon);
