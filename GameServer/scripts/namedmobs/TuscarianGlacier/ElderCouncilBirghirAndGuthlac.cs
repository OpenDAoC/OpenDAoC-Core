    ...
    public class Birghir : GameEpicBoss
    {
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                log.Warn("Elder Council Birghir exist ingame, remove it and restart server if you want to add by script code.");
        }
    }
}
    ...
    public class BirghirBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            ...
            if (Body.InCombat && HasAggro)
            {
                if(message1 == false)
                {
                    BroadcastMessage(String.Format(Body.Name + " says, 'The Ice Lords were right... They were right..." +
        ...
        public override void Think()
        {
            ...
            if (Body.InCombat && HasAggro)
            {
                ...
                if(IsBombUp==false && FrozenBomb.FrozenBombCount == 0)
                {
                    ...
                    new RegionTimer(Body, new RegionTimerCallback(SpawnBombTimer), Util.Random(35000,60000));//spawn frozen bomb every 35s-60s
                    IsBombUp = true;
                }
                if (message1 == false)
                {
    ...
    public class FrozenBomb : GameNPC
    {
        ...
        public override bool AddToWorld()
        {
            ...
            if (success)
            {
                ...
                new RegionTimer(this, new RegionTimerCallback(Explode), 20000);//20 seconds until this will explode and deal heavy cold dmg
            }
            return success;
        }
