...
public class Player
{
    ...
    public class PlayerInfo
    {
        ...
        public PlayerInfo(DbCoreCharacters player)
        {
            if (player == null)
                return;
    ...
    public class PlayerSpec
    {
        ...
        public PlayerSpec(DbCoreCharacters player)
        {
            if (player == null)
                return;
    ...
    public class PlayerTradeSkills
    {
        ...
        public PlayerTradeSkills(DbCoreCharacters player)
        {
            if (player == null)
                return;
    ...
    public List<PlayerInfo> GetAllPlayers()
    {
        ...
        var players = GameServer.Database.SelectObjects<DbCoreCharacters>(DB.Column("LastPlayed").IsGreatherThan(dayLimit));
