...
public class News
{
    ...
    public List<NewsInfo> GetAllNews()
    {
        ...
        if (cache == null)
        {
            ICollection<DBNews> newsList = DOLDB<DBNews>.SelectAllObjects().OrderBy(a => a.CreationDate).Take(_numNews).ToList();
    ...
    public List<NewsInfo> GetRealmNews(string realm)
    {
        ...
        if (cache == null)
        {
            ICollection<DBNews> newsList = DOLDB<DBNews>.SelectObjects(DB.Column("Realm").IsEqualTo(realm)).OrderBy(a => a.CreationDate).Take(_numNews).ToList();
    ...
    public List<NewsInfo> GetTypeNews(string type)
    {
        ...
        if (cache == null)
        {
            ICollection<DBNews> newsList = DOLDB<DBNews>.SelectObjects(DB.Column("Type").IsEqualTo(type)).OrderBy(a => a.CreationDate).Take(_numNews).ToList();
