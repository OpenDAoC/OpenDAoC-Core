...
class UnitSpellHandler
{
    ...
    public void CalculateDamageBase_SpellDamageIs100SourceIsAnimistPetWith100IntAndOwnerWith100Int_ReturnAround119()
    {
        ...
        owner.Level = 50; 
        var brain = new UnitFakeControlledBrain();
    ...
    private static GameLiving NewFakeLiving() => new UnitFakeLiving();
    ...
    private class FakePlayerSpy : UnitFakePlayer
    {
