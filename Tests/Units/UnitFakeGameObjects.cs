...
public class UnitFakePlayer : GamePlayer
{
    ...
    public UnitFakePlayer() : base(null, null)
    {
    ...
    public override IPacketLib Out => new UnitFakePacketLib();
...
public class UnitFakeNpc : GameNpc
{
    public int modifiedEffectiveLevel;

    public UnitFakeNpc(ABrain defaultBrain) : base(defaultBrain)
    {
        this.ObjectState = eObjectState.Active;
    }

    public UnitFakeNpc() : this(new UnitFakeBrain()) { }
...
public class UnitFakeLiving : GameLiving
{
...
public class UnitFakeControlledBrain : ABrain, IControlledBrain
{
...
public class UnitFakeBrain : ABrain
{
    public override void Think() { }
    public override void KillFSM() { }
}