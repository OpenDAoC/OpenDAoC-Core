...
class UnitGameEffectList
{
    ...
    private static GameEffectList NewGameEffectList() => NewGameEffectList(new UnitFakeNpc());
    private static GameEffectList NewGameEffectList(GameLiving owner) => new GameEffectList(owner);
    private static UnitFakeLiving NewFakeLiving() => new UnitFakeLiving();
    private static FakeGameEffect NewFakeEffect() => new FakeGameEffect();
    private static UnitFakeControlledBrain NewFakeControlledBrain() => new UnitFakeControlledBrain();
    ...
    private class FakeGameEffect : IGameEffect
    {
        ...
        public DbPlayerXEffect getSavedEffect() { throw new System.NotImplementedException(); }
    }
}